...
const renderActiveShape = (props: any) => {
  ...
  return (
    <g>
      ...
      <text x={ex + (cos >= 0 ? 1 : -1) * 12} y={ey} textAnchor={textAnchor} fill="#333">{`${value} locations`}</text>
    ...
    <div className="container space-y-8 p-8">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Comprehensive analytics and insights on location management across the platform.
        </p>
      </div>
              ...
              <div className="h-96 w-full">
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    <Tooltip />
                    <Legend />
                    <Bar dataKey="submissions" stackId="a" fill="#8884d8" name="Total Submissions" />
                    <Bar dataKey="approvals" stackId="b" fill="#82ca9d" name="Approvals" />
                    <Bar dataKey="rejections" stackId="b" fill="#ffc658" name="Rejections" />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </CardContent>
        ...
        <TabsContent value="regional" className="space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Monthly growth by top regions
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-80 w-full">
                <div className="flex items-center justify-center h-full">
                  <p className="text-muted-foreground">Regional growth data is being calculated. Check back soon.</p>
                </div>
              </div>
            </CardContent>
          </Card>
