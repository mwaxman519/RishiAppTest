...
export async function checkPermission(
  ...
  console.log(`Checking permission: ${permission} - DEVELOPMENT MODE: Always granted`);
  return true;
}
...
export async function hasPermission(permission: string, userRoles: string[] = []): Promise<boolean> {
...
export async function hasRoutePermission(route: string, userRoles: string[] = []): Promise<boolean> {
