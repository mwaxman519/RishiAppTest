...
export function getRolePermissions(role: UserRole): PermissionMap {
  switch (role) {
    case 'super_admin':
      return {
        locations: ['create', 'read', 'update', 'delete', 'approve', 'reject', 'manage', 'export'],
        bookings: ['create', 'read', 'update', 'delete', 'approve', 'reject', 'manage', 'export'],
        organizations: ['create', 'read', 'update', 'delete', 'manage', 'export'],
