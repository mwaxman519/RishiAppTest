...
export function createConnectionPool(): Pool {
  ...
  console.log(`Creating database connection pool for ${getEnvironment()} environment`);
  console.log(`Pool configuration: max=${poolConfig.max}, timeout=${poolConfig.connectionTimeoutMillis}ms`);
