 ...
 */
export const updateStaffSkillSchema = createStaffSkillSchema.omit({ staffId: true, skillId: true }).partial();
 ...
 */
export const updateAvailabilitySchema = createAvailabilitySchema.omit({ staffId: true }).partial();
 ...
 */
export const updateTimeOffRequestSchema = createTimeOffRequestSchema.omit({ staffId: true }).partial();
...
export type UpdateTimeOffRequestParams = z.infer<typeof updateTimeOffRequestSchema>;
export type ApproveTimeOffRequestParams = z.infer<typeof approveTimeOffRequestSchema>;
export type RejectTimeOffRequestParams = z.infer<typeof rejectTimeOffRequestSchema>;