  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-6 text-[rgb(var(--foreground))]">Categories</h2>
      ...
      <section className="mb-12">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-[rgb(var(--foreground))]">Recent Updates</h2>
          <Link 
      ...
      {/* Quick Links */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-6 text-[rgb(var(--foreground))]">Getting Started</h2>
