...
export default function FinalLocationPicker({ onAddressSelect, onLocationSelected, filterApprovedOnly, excludeLocationIds, className = '' }: Props): React.ReactNode {
    ...
    const setupAutocomplete = () => {
      ...
      try {
        ...
        autocompleteRef.current.addListener('place_changed', () => {
          ...
          if (place.name && place.types && (place.types.includes('establishment') || place.types.includes('point_of_interest'))) {
