...
export default function BookingsCalendarView({ bookings }: BookingsCalendarViewProps) {
    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between p-4 border-b">
        ...
        <div className="flex gap-1">
          ...
          <Button size="icon" variant="ghost" onClick={() => setCurrentMonth(new Date())}>
      ...
      <div className="grid grid-cols-7 text-center border-b">
        {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map(day => (
          <div key={day} className="py-2 font-medium text-sm text-muted-foreground">
            {day}
          </div>
        ))}
      </div>
                  ...
                  <div className="flex justify-between">
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        {format(booking.startDate, 'h:mm a')} - {format(booking.endDate, 'h:mm a')}
