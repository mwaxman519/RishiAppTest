  ...
  return (
    <div className="flex items-center justify-between h-14 px-3 bg-[rgb(var(--background))] border-b border-[rgb(var(--border))]">
      ...
      <div className="flex items-center gap-2">
        ...
        {user && <div className="hidden lg:block"><OrganizationSelector /></div>}
      ...
      <div className="flex items-center gap-2">
        ...
        <a href="/docs" className="hidden md:flex items-center px-3 py-1.5 text-sm font-medium rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
          Documentation
        </a>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-64">
                <div className="py-2 px-3">
                  ...
                  <p className="text-xs text-[rgb(var(--muted-foreground))]">You have no new notifications</p>
                </div>
                <DropdownMenuSeparator />
