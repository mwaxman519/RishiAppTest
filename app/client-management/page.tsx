...
const managementModules = [
  {
    ...
    actions: [
      { label: 'Add Client', href: '/client-management/accounts/create', permission: 'create:client-accounts' },
      { label: 'View All', href: '/client-management/accounts', permission: 'view:client-accounts' }
    ]
  },
  {
    ...
    actions: [
      { label: 'Add Location', href: '/client-management/locations/create', permission: 'create:locations' },
      { label: 'View All', href: '/client-management/locations', permission: 'view:locations' }
    ]
  },
  {
    title: 'Kit Management',
    description: 'Manage kit templates and deployed equipment kits',
    icon: <Package2 className="h-10 w-10 text-purple-600 dark:text-purple-400" />,
    ...
    actions: [
      { label: 'Add Kit', href: '/client-management/kits/create', permission: 'create:kits' },
      { label: 'View All', href: '/client-management/kits', permission: 'view:kits' }
    ]
  },
  {
    ...
    actions: [
      { label: 'Assign Staff', href: '/client-management/staff/create', permission: 'assign:staff' },
      { label: 'View All', href: '/client-management/staff', permission: 'view:staff' }
    ]
  },
  {
    title: 'Client Users',
    description: 'Manage client user accounts and access control',
    icon: <UserCog className="h-10 w-10 text-indigo-600 dark:text-indigo-400" />,
    ...
    actions: [
      { label: 'Add User', href: '/client-management/users/create', permission: 'create:client-users' },
      { label: 'View All', href: '/client-management/users', permission: 'view:client-users' }
    ]
  },
  {
    ...
    actions: [
      { label: 'Create Invoice', href: '/client-management/billing/invoices/create', permission: 'create:invoices' },
      { label: 'View All', href: '/client-management/billing', permission: 'view:invoices' }
    ]
  }
];
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600 dark:text-gray-400 text-lg">
          Comprehensive tools for managing client organizations, facilities, and resources
        </p>
      </div>
            ...
            <CardHeader className="pb-2">
              <div className="flex items-start justify-between">
                ...
                <div className="bg-gray-100 dark:bg-gray-800 rounded-lg px-3 py-2 text-center">
                  ...
                  <div className="text-xs text-gray-500 dark:text-gray-400">{module.stats.label}</div>
                </div>
              </div>
