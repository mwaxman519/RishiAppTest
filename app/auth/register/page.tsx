      ...
      <div className="flex items-center justify-center w-full md:w-1/2 p-8">
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="text-center">
            <h1 className="text-3xl font-bold tracking-tight text-foreground">Rishi</h1>
            <p className="text-sm text-muted-foreground mt-1">Workforce Management Platform</p>
          </div>
          ...
          <div className="max-w-lg text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Join the Rishi Platform to streamline your operations and connect with opportunities.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4 text-left">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">Enter your details and registration passcode to get started</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4 text-left">
                ...
                <div className="space-y-1">
                  <h3 className="font-semibold text-foreground">Set Up Your Profile</h3>
              ...
              <div className="flex items-start space-x-4 text-left">
                ...
                <div className="space-y-1">
                  <h3 className="font-semibold text-foreground">Start Managing</h3>
                  <p className="text-sm text-muted-foreground">Access your dashboard and begin managing your availability</p>
                </div>
              </div>
            </div>
