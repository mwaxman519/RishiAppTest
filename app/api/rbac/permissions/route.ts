...
export async function GET(req: NextRequest) {
  try {
    ...
    const mockPermissions = [
      ...
      { name: 'view:analytics', description: 'View analytics and reporting data' },
      ...
      { name: 'edit:whitelabel', description: 'Edit white-label configurations' },
      
      { name: 'admin:users', description: 'Administer user accounts' },
      { name: 'admin:roles', description: 'Manage user roles' },
      { name: 'admin:permissions', description: 'Configure system permissions' },
