...
async function handleMemberAssigned(payload: any) {
  console.log('Processing member assignment:', payload.memberId, 'to event:', payload.eventId);
}
...
async function handleTaskAssigned(payload: any) {
  console.log('Processing task assignment:', payload.taskId, 'to:', payload.assigneeId);
}