        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card className="border-amber-200">
            <CardHeader className="pb-3">
              ...
              <CardDescription>Events awaiting management approval</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                <div className="flex justify-between border-b pb-2">
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Acme Corporation • May 15, 2025</div>
                  </div>
                  <Link
                ...
                <div className="flex justify-between border-b pb-2">
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Globex Industries • June 5-7, 2025</div>
                  </div>
                  <Link
                ...
                <div className="flex justify-between">
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Initech • May 20-22, 2025</div>
                  </div>
                  <Link
          ...
          <Card className="border-amber-200">
            <CardHeader className="pb-3">
              ...
              <CardDescription>Events requiring staff assignment</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                <div className="flex justify-between border-b pb-2">
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Needs 3 more staff • April 25, 2025</div>
                  </div>
                  <Link
                ...
                <div className="flex justify-between border-b pb-2">
                  <div>
                    <div className="font-medium">Product Launch</div>
                    <div className="text-sm text-muted-foreground">Needs 5 more staff • May 10, 2025</div>
                  </div>
                  <Link
                ...
                <div className="flex justify-between">
                  <div>
                    <div className="font-medium">Trade Show</div>
                    <div className="text-sm text-muted-foreground">Needs 8 more staff • June 5-7, 2025</div>
                  </div>
                  <Link
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardDescription>Current staff deployment and availability</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                <div className="flex justify-between border-b pb-2">
