          ...
          <div className="relative z-10">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-4 lg:space-y-0">
              <div>
                ...
                <p className="text-green-100 text-lg">Manage your events and workforce with confidence</p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <Card className="bg-gradient-to-br from-emerald-500 to-emerald-600 text-white border-0 shadow-xl">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-emerald-100 font-medium">Events Completed</p>
          ...
          <Card className="bg-gradient-to-br from-purple-500 to-purple-600 text-white border-0 shadow-xl">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-purple-100 font-medium">Satisfaction Rate</p>
              ...
              <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <CardDescription>Your planned marketing activations</CardDescription>
                  </div>
                      ...
                      <div className="flex justify-between items-start mb-3">
                        ...
                        <Badge 
                          className={`${
                            ...
                            event.status === 'pending_approval' ? 'bg-yellow-100 text-yellow-800 border-yellow-200' :
                            'bg-blue-100 text-blue-800 border-blue-200'
                          } px-3 py-1`}
                        >
                          {event.status === 'confirmed' ? 'CONFIRMED' :
                           event.status === 'pending_approval' ? 'PENDING' : 'PLANNING'}
                        </Badge>
                      </div>
                      ...
                      <div className="flex justify-between items-center">
                        <div className="flex items-center space-x-4">
                          <div className="text-sm">
                            ...
                            <span className="font-semibold text-green-600">{event.budget}</span>
                          </div>
                          <div className="text-sm">
                  ...
                  <div key={booking.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600">{booking.date} • {booking.staffCount} staff</p>
