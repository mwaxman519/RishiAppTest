  ...
  return useMutation({
    ...
    onSuccess: (data, variables) => {
      ...
      toast({
        ...
        description: 'Field manager has been assigned to the event successfully.',
        variant: 'success'
      });
    },
    onError: (error: Error) => {
      toast({
        ...
        description: error.message || 'An error occurred while assigning the manager.',
        variant: 'destructive'
      });
    }
  });
  ...
  return useMutation({
    ...
    onError: (error: Error) => {
      toast({
        ...
        description: error.message || 'An error occurred while starting preparation.',
        variant: 'destructive'
      });
    }
  });
