...
const alertsData = [
  {
    ...
    description: "Slow query performance detected in production environment on the main database cluster. Multiple queries taking over 5 seconds to complete.",
    status: "critical",
    category: "system",
    ...
    assignedTo: null,
    metrics: [
      { name: "Query Response Time", value: "5.2s", change: "+220%", status: "negative" },
      { name: "CPU Usage", value: "92%", change: "+45%", status: "negative" },
      { name: "Connection Count", value: "128", change: "+30%", status: "warning" }
    ],
    activity: [
      { 
        type: "alert_created", 
  ...
  },
  {
    ...
    description: "Rate limit threshold reached for external API calls. This may impact third-party service integrations.",
    status: "critical",
    category: "api",
    ...
    assignedTo: null,
    metrics: [
      { name: "API Requests/Min", value: "450", change: "+180%", status: "negative" },
      { name: "Error Rate", value: "15%", change: "+1200%", status: "negative" },
      { name: "Response Time", value: "2.8s", change: "+340%", status: "negative" }
    ],
    activity: [
      { 
        type: "alert_created", 
...
const getStatusBadge = (status: string) => {
  switch (status) {
    case 'critical':
      return <Badge variant="destructive" className="rounded-sm px-2 py-1">Critical</Badge>;
    case 'warning':
      return <Badge variant="outline" className="bg-amber-100 text-amber-800 hover:bg-amber-100 border-amber-200 rounded-sm px-2 py-1">Warning</Badge>;
    case 'info':
      return <Badge variant="outline" className="bg-blue-100 text-blue-800 hover:bg-blue-100 border-blue-200 rounded-sm px-2 py-1">Info</Badge>;
    default:
      return <Badge variant="outline" className="rounded-sm px-2 py-1">{status}</Badge>;
  }
};
        ...
        <div className="grid grid-cols-3 gap-6">
              ...
              <TabsContent value="discussion">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Discuss this alert with your team</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="text-center py-6 text-muted-foreground">
                        ...
                        <p>No comments yet</p>
                        <p className="text-sm">Be the first to comment on this alert</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
          ...
          <div className="space-y-6">
              ...
              <CardContent>
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{format(alert.createdAt, 'MMM d, h:mm a')}</span>
                  </div>
                  <Separator />
                  <div className="flex justify-between">
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="text-center py-6 text-muted-foreground">
                    ...
                    <p className="text-sm">Assign team members to collaborate on this alert</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  <Link href="/admin/alerts/2" className="block p-3 rounded-md border hover:bg-muted">
                    <div className="flex items-center">
                      <BadgeAlert className="h-4 w-4 text-red-500 mr-2" />
                      <span className="font-medium">API Rate Limiting</span>
                    </div>
                    <p className="text-sm text-muted-foreground mt-1">Rate limit threshold reached for external API calls</p>
                  </Link>
                </div>
              </CardContent>
            </Card>
