    ...
    <div>
      ...
      >
        <TabsList className="grid grid-cols-5 w-full">
          ...
          <Link href={`${baseUrl}/settings?organizationId=${organizationId}`} passHref legacyBehavior>
            <TabsTrigger value="settings" className="cursor-pointer">
              Settings
            </TabsTrigger>
          </Link>
          
          <Link href={`${baseUrl}/branding?organizationId=${organizationId}`} passHref legacyBehavior>
            <TabsTrigger value="branding" className="cursor-pointer">
              Branding
            </TabsTrigger>
          </Link>
          
          <Link href={`${baseUrl}/users?organizationId=${organizationId}`} passHref legacyBehavior>
            <TabsTrigger value="users" className="cursor-pointer">
              Users
            </TabsTrigger>
          </Link>
          
          <Link href={`${baseUrl}/roles?organizationId=${organizationId}`} passHref legacyBehavior>
