...
import { Calendar, TrendingUp, Users, MapPin, Activity, Download } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{analyticsData.organizations}</div>
            <p className="text-xs text-muted-foreground">
              Active clients
            </p>
          </CardContent>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="w-16 bg-gray-200 rounded-full h-2">
                      <div 
                        ...
                        style={{ width: `${(item.count / analyticsData.totalEvents) * 100}%` }}
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="w-16 bg-gray-200 rounded-full h-2">
                      <div 
                        ...
                        style={{ width: `${(item.count / analyticsData.totalUsers) * 100}%` }}
                      />
                    </div>
                  </div>
                </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Event Success Rate</p>
            </div>
            <div className="text-center">
