...
export default function NewUserPage() {
  ...
  if (!user) {
    return (
      <SidebarLayout>
        <div className="p-6">
          <h1 className="text-2xl font-bold mb-6 text-gray-900 dark:text-gray-100">Add New User</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value={USER_ROLES.INTERNAL_ACCOUNT_MANAGER}>Internal Account Manager</option>
