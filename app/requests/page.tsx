...
import { Calendar, CheckCircle, ClockIcon, XCircle, CalendarDays, Filter } from "lucide-react";
              ...
              <CardHeader className="pb-3">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <CardDescription>
                      <span className="font-medium">Acme Corporation</span> • Tier 2
                    </CardDescription>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <p className="font-medium">May 15, 2025 • 10:00 AM - 4:00 PM</p>
                    </div>
                    <div>
                  ...
                  <div className="pt-2 border-t">
                    <p className="text-muted-foreground text-sm mb-1">Request Notes</p>
                    <p className="text-sm">Staff should have knowledge of our new product line and be able to demonstrate features to potential clients.</p>
                  </div>
              ...
              <CardHeader className="pb-3">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <CardDescription>
                      <span className="font-medium">Globex Industries</span> • Tier 3
                    </CardDescription>
                  </div>
                  <span className="text-xs font-medium py-1 px-3 rounded-full bg-amber-100 text-amber-800">
                    Pending
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <p className="text-muted-foreground">Date & Time</p>
                      <p className="font-medium">June 5-7, 2025 • 9:00 AM - 5:00 PM</p>
                    </div>
                    <div>
                      <p className="text-muted-foreground">Location</p>
                  ...
                  <div className="pt-2 border-t">
                    <p className="text-muted-foreground text-sm mb-1">Request Notes</p>
                    <p className="text-sm">Need staff with technical expertise who can engage with industry professionals. Booth will require full setup on June 4th.</p>
                  </div>
              ...
              <CardHeader className="pb-3">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <CardDescription>
                      <span className="font-medium">Initech Solutions</span> • Tier 2
                    </CardDescription>
                  </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <p className="text-muted-foreground">Date & Time</p>
                      <p className="font-medium">April 28, 2025 • 1:00 PM - 5:00 PM</p>
                    </div>
                    <div>
                      <p className="text-muted-foreground">Location</p>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <p className="text-muted-foreground">Date & Time</p>
                      <p className="font-medium">April 22-24, 2025 • 8:00 AM - 6:00 PM</p>
                    </div>
                    <div>
                      <p className="text-muted-foreground">Location</p>
