    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <h2 className="text-xl font-semibold mb-6 text-gray-800 dark:text-white">User Preferences</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-medium text-gray-700 dark:text-gray-300 border-b pb-2">Account Settings</h3>
                
                <div className="flex items-center justify-between">
                  <label htmlFor="twoFactorAuth" className="text-gray-700 dark:text-gray-300">
                ...
                <div>
                  <label htmlFor="autoLogout" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    Auto Logout (minutes)
                  </label>
                  <select
                    id="autoLogout"
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-medium text-gray-700 dark:text-gray-300 border-b pb-2">Appearance & Notifications</h3>
                ...
                <div className="flex items-center justify-between">
                  <label htmlFor="emailUpdates" className="text-gray-700 dark:text-gray-300">
                    Email Updates
                  </label>
                  <div className="relative inline-block w-12 h-6 transition duration-200 ease-in-out">
                    <input
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
            <h3 className="text-lg font-medium text-gray-700 dark:text-gray-300 mb-4">Advanced Settings</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              These settings are placeholders for future functionality. They will be implemented in a future update.
            </p>
            <div className="flex space-x-3">
              <button
                onClick={() => alert('Change Password feature will be implemented in a future update')}
              ...
              <button
                onClick={() => alert('Export Data feature will be implemented in a future update')}
                className="px-4 py-2 bg-gray-200 text-gray-800 dark:bg-gray-700 dark:text-white rounded hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors"
              >
                Export Data
              </button>
