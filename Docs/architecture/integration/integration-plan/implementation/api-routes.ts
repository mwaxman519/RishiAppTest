...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json(
      { success: true, message: "Manager assigned to event", event: updatedEvent },
      { status: 200 }
    );
  } catch (error: any) {
...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json(
      { success: true, message: "Event preparation started", event: updatedEvent },
      { status: 200 }
    );
  } catch (error: any) {
...
export async function POST(
  ...
  try {
    ...
    // Report the issue
    const updatedEvent = await bookingsEventsService.reportEventIssue(
      eventId,
      {
        ...validatedData,
