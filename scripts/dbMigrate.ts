...
async function migrateToUUID() {
  ...
  try {
    ...
    console.log('ID mapping created:', idMapping.map(m => ({ oldId: m.oldId, newId: m.newId })));
...
`;
    ...
    console.log('Migration script completed. Review generated SQL before executing!');
