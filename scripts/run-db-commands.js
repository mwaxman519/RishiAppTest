...
// Validation
const validCommands = ['migrate', 'seed', 'validate', 'sanitize', 'clean', 'deploy'];
...
if (command === 'clean' && env === 'production') {
  console.warn('⚠️ WARNING: You are about to clean test data from the PRODUCTION environment!');
  console.warn('This is a destructive operation and should only be done if you are sure.');
...
if (command === 'deploy' && env === 'production') {
  console.warn('⚠️ WARNING: You are about to deploy to the PRODUCTION environment!');
