...
function validatePrerequisites() {
  ...
  // Check file count
  const fileCount = execSync("find . -name '*.ts' -o -name '*.tsx' | grep -v node_modules | wc -l", { encoding: 'utf8' });
...
function main() {
  ...
  try {
    ...
    log('Run: git add . && git commit -m "Emergency Azure deployment" && git push');
