...
const migrationMap = {
  ...
  '2-Build-Optimization.md': 'development-guides/optimizations/build-optimization.md',
  '3-Database-Best-Practices.md': 'development-guides/database/best-practices.md',
  '4-CI-CD-and-Deployment.md': 'deployment/ci-cd-practices.md',
  '5-Development-Workflow.md': 'development-guides/workflow.md', 
  '6-Common-TypeScript-Fixes.md': 'development-guides/typescript/common-fixes.md',
  'typescript-guidelines.md': 'development-guides/typescript/detailed-guidelines.md',
  ...
  // Miscellaneous
  'chunk-error-fixes.md': 'development-guides/troubleshooting/chunk-error-fixes.md',
  ...
  for (const [sourceFile, targetPath] of Object.entries(migrationMap)) {
    ...
    if (fs.existsSync(sourcePath)) {
      ...
      try {
        ...
        const updatedContent = addOrUpdateFrontmatter(content, path.basename(targetPath, '.md'));
