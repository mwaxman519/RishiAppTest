...
async function checkConnection() {
  ...
  try {
    ...
    console.log('Auth tables found:', authTablesResult.rows.map(row => row.table_name));
...
async function runDatabaseChecks() {
  ...
  if (!isConnected) {
    ...
    console.log('Database URL format valid:', dbUrl.startsWith('postgres://') || dbUrl.startsWith('postgresql://'));
