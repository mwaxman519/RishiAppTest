...
export default function RolesPage() {
  const [activeTab, setActiveTab] = useState<'role-manager' | 'all-permissions' | 'access-map'>('role-manager');
      ...
      <div className="pt-4">
        ...
        {activeTab === 'all-permissions' && (
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">View all permissions for all roles in the system.</p>
        ...
        {activeTab === 'access-map' && (
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">Visualize which roles have access to specific routes in the application.</p>
  ...
  const routeGroups = [
    {
      ...
      routes: ['/users', '/users/create', '/users/edit', '/users/agents', '/users/managers', '/users/roles', '/users/activity']
    },
    {
      name: 'Client Management',
      routes: ['/clients', '/clients/create', '/clients/edit', '/clients/billing']
    },
    {
      name: 'Field Management',
      routes: ['/field', '/field/teams', '/field/regions', '/field/regions/assign']
    },
    {
    ...
    },
    {
      ...
      routes: ['/marketing', '/marketing/create', '/marketing/edit', '/marketing/approve']
    },
    {
      name: 'Agent Management',
      routes: ['/agents', '/agents/create', '/agents/edit', '/agents/assign', '/agents/performance']
    },
    {
      name: 'Dispensary Management',
      routes: ['/dispensaries', '/dispensaries/create', '/dispensaries/edit', '/dispensaries/assign']
    },
    {
      name: 'Scheduling',
      routes: ['/scheduling', '/scheduling/calendar', '/scheduling/appointments', '/scheduling/manage']
    },
    {
      name: 'Reports',
    ...
    {
      name: 'Administration',
      routes: ['/admin', '/admin/settings', '/admin/logs', '/admin/metrics', '/admin/configuration']
    }
  ];
    ...
    <div className="space-y-6">
        ...
        <div key={index} className="border rounded-lg p-4">
          ...
          <div className="space-y-2">
            {group.routes.map((route, routeIndex) => (
              <div key={routeIndex} className="py-2 px-4 bg-gray-50 rounded flex justify-between">
                <span className="font-mono text-sm">{route}</span>
                <div className="flex space-x-2">
                  {/* This is where role access indicators would be shown */}
                  <span className="text-xs px-2 py-1 bg-green-100 text-green-800 rounded">
                    {route.includes('create') || route.includes('edit') || route.includes('delete') 
                      ? 'Admin+ only' 
      ...
      <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-md">
        <p className="text-yellow-800 text-sm">
          Note: This is a visual representation of route access. The actual permissions are enforced by the authorization middleware.
        </p>
      </div>
    </div>
  );
