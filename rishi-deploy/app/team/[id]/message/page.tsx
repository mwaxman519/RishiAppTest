...
import { ArrowLeft, Send, MessageSquare, Clock, Bell, CheckSquare, Calendar } from 'lucide-react';
...
export default function MessageTeamMemberPage({ params }: MessageTeamMemberProps) {
  const { id } = use(params);
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Select value={messageData.template} onValueChange={handleTemplateChange}>
                  <SelectTrigger>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={messageData.deliveryMethod} onValueChange={(value) => handleInputChange('deliveryMethod', value)}>
                    <SelectTrigger>
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleInputChange('scheduleDelivery', checked as boolean)}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleInputChange('requiresResponse', checked as boolean)}
                />
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleInputChange('createTask', checked as boolean)}
                />
