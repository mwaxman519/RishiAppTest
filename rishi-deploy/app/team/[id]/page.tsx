...
import { ArrowLeft, Mail, Phone, MapPin, Star, Calendar, Clock, TrendingUp, Award, Edit, MessageSquare, UserPlus, Home, Shield, Smartphone, User, CreditCard, AlertTriangle, Users, Building } from 'lucide-react';
...
const getTeamMemberById = (id: string) => {
  const members = {
    '1': {
      ...
      recentEvents: [
        { id: 1, name: 'Tech Conference 2024', date: '2024-06-10', status: 'completed', rating: 4.9 },
        { id: 2, name: 'Product Launch Demo', date: '2024-06-05', status: 'completed', rating: 4.7 },
        { id: 3, name: 'Corporate Training', date: '2024-05-28', status: 'completed', rating: 4.8 }
      ],
      performance: {
        onTimeRate: 96,
    ...
    '2': {
      ...
      recentEvents: [
        { id: 4, name: 'Retail Expo 2024', date: '2024-06-12', status: 'completed', rating: 5.0 },
        { id: 5, name: 'Brand Activation Campaign', date: '2024-06-08', status: 'completed', rating: 4.8 },
        { id: 6, name: 'Trade Show Demo', date: '2024-06-01', status: 'completed', rating: 4.9 }
      ],
      performance: {
        onTimeRate: 98,
...
export async function generateMetadata({ params }: TeamMemberDetailsProps): Promise<Metadata> {
...
export default async function TeamMemberDetailsPage({ params }: TeamMemberDetailsProps) {
  const { id } = await params;
  const member = getTeamMemberById(id);
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:space-y-0 sm:space-x-4">
        ...
        <div className="flex-1">
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">Team Member Profile</h1>
        ...
        <CardContent className="p-6">
          <div className="flex flex-col lg:flex-row items-start space-y-6 lg:space-y-0 lg:space-x-6">
              ...
              <div className="flex-1 text-center sm:text-left space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3">
                  ...
                  <div className="flex items-center justify-center sm:justify-start space-x-2 min-w-0 p-2 bg-muted/30 rounded-lg">
                    ...
                    <span className="text-sm truncate">Joined {new Date(member.joinDate).toLocaleDateString()}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center lg:items-end space-y-2 w-full lg:w-auto">
              ...
              <p className="text-sm text-muted-foreground text-center lg:text-right">{member.eventsCompleted} events completed</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Tabs defaultValue="personal" className="space-y-6">
        <div className="w-full overflow-x-auto">
          <TabsList className="grid w-full grid-cols-3 sm:grid-cols-6 min-w-max sm:min-w-full">
            ...
            <TabsTrigger value="work" className="text-xs sm:text-sm">Work Details</TabsTrigger>
            <TabsTrigger value="performance" className="text-xs sm:text-sm">Performance</TabsTrigger>
            <TabsTrigger value="events" className="text-xs sm:text-sm">Recent Events</TabsTrigger>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="flex items-center space-x-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{member.personalEmail}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                ...
                <div className="flex items-center space-x-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{member.lastDeviceType}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center space-x-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                    ...
                    <div>
                      ...
                      <p className="text-sm">{new Date(member.personalInfo.dateOfBirth).toLocaleDateString()}</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                  ...
                  <div className="flex items-center space-x-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                    ...
                    <div>
                      <p className="text-xs font-medium text-muted-foreground">Work Eligibility</p>
                      <p className="text-sm">{member.personalInfo.workEligibility}</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                    ...
                    <div>
                      ...
                      <p className="text-sm">{member.personalInfo.driversLicense}</p>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-950/20 dark:to-red-950/20">
                ...
                <CardDescription>Size and equipment information</CardDescription>
              </CardHeader>
              <CardContent className="p-6 space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center space-x-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                    ...
                    <div>
                      <p className="text-xs font-medium text-muted-foreground">Shirt Size</p>
                      <p className="text-lg font-semibold">{member.shirtSize}</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div className="flex items-center space-x-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{member.manager}</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
              ...
              <CardContent className="p-6 space-y-4">
                <div className="flex items-center space-x-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{member.bankingInfo.accountType}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{member.bankingInfo.bankName}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">****{member.bankingInfo.routingLast4}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="lg:col-span-2 overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-950/20 dark:to-indigo-950/20">
                ...
                <CardDescription>Current performance metrics and ratings</CardDescription>
              </CardHeader>
              <CardContent className="p-6">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  <div className="text-center p-4 rounded-lg bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950/20 dark:to-blue-900/20">
                    <div className="text-2xl font-bold text-blue-600">{member.performance.onTimeRate}%</div>
                  ...
                  <div className="text-center p-4 rounded-lg bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950/20 dark:to-green-900/20">
                    <div className="text-2xl font-bold text-green-600">{member.performance.customerSatisfaction}/5.0</div>
                  ...
                  <div className="text-center p-4 rounded-lg bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950/20 dark:to-purple-900/20">
                    <div className="text-2xl font-bold text-purple-600">{member.performance.eventCompletionRate}%</div>
                  ...
                  <div className="text-center p-4 rounded-lg bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-950/20 dark:to-orange-900/20">
                    <div className="text-2xl font-bold text-orange-600">{member.performance.responseTime}</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="overflow-hidden">
              ...
              <CardContent className="p-6 space-y-4">
                <div className="flex items-center space-x-3 p-4 rounded-lg bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800">
                  ...
                  <div>
                    <p className="font-medium text-red-900 dark:text-red-100">{member.emergencyContact.name}</p>
                    <p className="text-sm text-red-700 dark:text-red-300">{member.emergencyContact.relationship}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3 p-4 rounded-lg bg-orange-50 dark:bg-orange-950/20 border border-orange-200 dark:border-orange-800">
                  ...
                  <div>
                    <p className="font-medium text-orange-900 dark:text-orange-100">Emergency Phone</p>
                    <p className="text-sm text-orange-700 dark:text-orange-300">{member.emergencyContact.phone}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-950/20 dark:to-blue-950/20">
                ...
                <CardDescription>Common profile management actions</CardDescription>
              </CardHeader>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{member.performance.onTimeRate}%</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm">Customer Satisfaction</span>
                  <span className="font-medium">{member.performance.customerSatisfaction}/5.0</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm">Completion Rate</span>
                  <span className="font-medium">{member.performance.eventCompletionRate}%</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm">Response Time</span>
                  <span className="font-medium">{member.performance.responseTime}</span>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-6">
                <div>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-sm">{member.performance.onTimeRate}%</span>
                  </div>
                  <Progress value={member.performance.onTimeRate} className="h-2" />
                </div>
                <div>
                  <div className="flex justify-between mb-2">
                    <span className="text-sm font-medium">Event Completion</span>
                    <span className="text-sm">{member.performance.eventCompletionRate}%</span>
                  </div>
                  <Progress value={member.performance.eventCompletionRate} className="h-2" />
                </div>
                <div>
                  <div className="flex justify-between mb-2">
                    <span className="text-sm font-medium">Customer Satisfaction</span>
                    <span className="text-sm">{member.performance.customerSatisfaction}/5.0</span>
                  </div>
                  <Progress value={(member.performance.customerSatisfaction / 5) * 100} className="h-2" />
                </div>
              </CardContent>
            </Card>
        ...
        <TabsContent value="events" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Latest event assignments and performance</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
