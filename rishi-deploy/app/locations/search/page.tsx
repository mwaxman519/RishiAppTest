...
export default function LocationSearchPage() {
  const [searchResults, setSearchResults] = useState<LocationDTO[]>(sampleLocations);
  ...
  return (
    <GoogleMapsProvider>
      <div className="container mx-auto py-8">
        <h1 className="text-3xl font-bold mb-6">Location Search & Google Maps Integration</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="lg:col-span-2">
            <CardHeader>
              ...
              <CardDescription>Search for locations using multiple filters</CardDescription>
            </CardHeader>
            <CardContent>
              <LocationSearch 
                          ...
                          <div>
                            ...
                            <div className="flex items-start mt-2">
                              ...
                              <div className="text-sm text-muted-foreground">
                                ...
                                <p>{location.city}, {location.state?.abbreviation} {location.zipcode}</p>
                              </div>
                            </div>
                          </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="mb-4">
                <h3 className="text-sm font-medium mb-2">Places Autocomplete</h3>
                <PlacesAutocomplete 
              ...
              {selectedLocation && selectedLocation.latitude && selectedLocation.longitude ? (
                <div className="space-y-4">
                  ...
                  <div className="p-3 bg-accent rounded-lg">
                    ...
                    <p className="text-sm">{selectedLocation.type} - {selectedLocation.status}</p>
                    <p className="text-sm text-muted-foreground mt-1">
                      {selectedLocation.address1}, {selectedLocation.city}, {selectedLocation.state?.abbreviation}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-center bg-muted h-[300px] rounded-md border">
                  <div className="text-center p-4">
                    ...
                    <p className="text-muted-foreground">Select a location or place to view on map</p>
                  </div>
                </div>
              )}
            </CardContent>
