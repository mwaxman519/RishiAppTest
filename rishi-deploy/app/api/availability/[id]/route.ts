...
export async function PUT(req: NextRequest,
  ...
  try {
    ...
    console.log(`Received update request for availability block ${id}:`, updateData);

    // Use the imported availabilityService instance
    const result = await availabilityService.updateAvailabilityBlock(id, updateData);
...
export async function DELETE(req: NextRequest,
  ...
  try {
    ...
    console.log(`DELETE request for block ID ${id} with deleteSeries=${deleteSeries}`);

    // Use the imported availabilityService instance with the deleteSeries parameter
    const result = await availabilityService.deleteAvailabilityBlock(id, deleteSeries);
