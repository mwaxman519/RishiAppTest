...
import { isUserInOrganization, getOrganizationById } from '../../../lib/organization-server';
import { FeatureModuleRegistry, getAllModules, isFeatureAvailableForTier } from '../../../../shared/features/registry';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const featuresWithStatus = featureModules.map((module) => {
      const orgTier = (organization.tier as 'tier_1' | 'tier_2' | 'tier_3') || 'tier_1';
