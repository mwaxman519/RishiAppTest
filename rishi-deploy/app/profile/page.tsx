          ...
          {isEditing ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-4 border border-gray-200 dark:border-gray-700 rounded">
                <h3 className="font-medium text-gray-700 dark:text-gray-300 mb-2">Username</h3>
                <p className="text-gray-900 dark:text-white">{user?.username || 'N/A'}</p>
              </div>
              
              <div className="p-4 border border-gray-200 dark:border-gray-700 rounded">
                <h3 className="font-medium text-gray-700 dark:text-gray-300 mb-2">Full Name</h3>
                <p className="text-gray-900 dark:text-white">{user?.full_name || 'Not provided'}</p>
              </div>
              
              <div className="p-4 border border-gray-200 dark:border-gray-700 rounded">
                <h3 className="font-medium text-gray-700 dark:text-gray-300 mb-2">Role</h3>
                <p className="text-gray-900 dark:text-white">{user?.role || 'N/A'}</p>
              </div>
              
              <div className="p-4 border border-gray-200 dark:border-gray-700 rounded">
                <h3 className="font-medium text-gray-700 dark:text-gray-300 mb-2">User ID</h3>
              ...
              <div className="p-4 border border-gray-200 dark:border-gray-700 rounded md:col-span-2">
                <h3 className="font-medium text-gray-700 dark:text-gray-300 mb-2">Profile Status</h3>
                <p className="text-gray-900 dark:text-white">
                  This is a profile placeholder. In a future update, users will be able to edit their profiles.
                </p>
              </div>
            </div>
          )}
