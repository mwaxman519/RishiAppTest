      ...
      <div className="flex-1 flex flex-col md:flex-row">
        ...
        <div className="hidden md:flex md:w-1/2 bg-[rgb(var(--primary))] text-white p-8 flex-col justify-between">
          <div>
            ...
            <p className="text-xl mb-6">Cannabis Workforce Management Platform</p>
            <p className="text-lg opacity-90">
              Login to access your Rishi Brand Agent dashboard, manage your availability and schedule.
            </p>
          </div>
          ...
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="remember-me" className="ml-2 block text-sm text-[rgb(var(--muted-foreground))]">
                    Remember me
                  </label>
                </div>
                
                <div className="text-sm">
                  <a href="#" className="font-medium text-[rgb(var(--primary))] hover:opacity-80">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-[rgb(var(--muted-foreground))]">
                ...
                <SafeLink href="/auth/register" className="font-medium text-[rgb(var(--primary))] hover:opacity-80">
                  Sign up
                </SafeLink>
              </p>
            </div>
