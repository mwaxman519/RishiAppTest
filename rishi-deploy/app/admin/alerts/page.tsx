      ...
      <header className="mb-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Monitor and manage system alerts across the platform</p>
          </div>
                            ...
                            <div className="flex justify-end gap-2">
                              ...
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                  ...
                                  <DropdownMenuItem>Assign Alert</DropdownMenuItem>
                                  <DropdownMenuItem>Mark as Resolved</DropdownMenuItem>
                                  <DropdownMenuSeparator />
                                  <DropdownMenuItem>Silence Alert</DropdownMenuItem>
                                </DropdownMenuContent>
                              </DropdownMenu>
                            </div>
                          </td>
              ...
              {filteredAlerts.length > 0 && (
                <div className="flex items-center justify-between mt-4">
                  <div className="text-sm text-muted-foreground">
                    Showing {Math.min(filteredAlerts.length, (currentPage - 1) * itemsPerPage + 1)} to {Math.min(filteredAlerts.length, currentPage * itemsPerPage)} of {filteredAlerts.length} alerts
                  </div>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex flex-col items-center justify-center text-center p-8">
                ...
                <p className="text-muted-foreground mt-2">
                  There are no recently resolved alerts. Check back later or view history.
                </p>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-center text-muted-foreground p-4">
                View and manage all alerts across the system, including resolved and acknowledged alerts.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
