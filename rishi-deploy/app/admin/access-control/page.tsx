  ...
  return (
    <div className="container mx-auto p-6 max-w-6xl">
      ...
      <p className="text-muted-foreground mb-8">
        Manage role-based access control settings across the platform. Configure system-wide defaults and organization-specific permissions.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Card className="hover:shadow-lg transition-shadow">
          <CardHeader>
            ...
            <CardDescription>
              Visual overview of all roles and their permissions across the platform
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Link 
