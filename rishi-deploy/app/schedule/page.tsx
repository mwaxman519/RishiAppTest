...
import { Calendar, Clock, Plus, MapPin, User, CheckCircle, AlertCircle } from 'lucide-react';
                    ...
                    <div className="space-y-3 flex-1">
                      ...
                      <div className="flex items-center justify-between pt-2 border-t">
                        <span className="text-sm text-muted-foreground">
                          Role: <span className="font-medium text-foreground">{event.role}</span>
                        </span>
        ...
        <TabsContent value="availability" className="space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Click and drag to set your availability. Green blocks show when you're available, red blocks show when you're unavailable.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground">
                  Your completed events and performance history will be displayed here
                </p>
              </div>
            </CardContent>
          </Card>
