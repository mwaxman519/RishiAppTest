...
import { User, Users, Clock, CalendarCheck, FileText, Award, Plus, Calendar } from "lucide-react";
      ...
      <Tabs defaultValue="directory" className="w-full">
        ...
        <TabsContent value="directory" className="space-y-6">
          <p className="text-muted-foreground mb-4">
            Manage all Rishi staff members, including internal employees and brand agents.
          </p>
        ...
        <TabsContent value="certifications" className="space-y-6">
          <p className="text-muted-foreground mb-4">
            Manage staff certifications for brand knowledge and technical skills.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>Training for specific brand product knowledge</CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between items-center p-2 bg-muted rounded-md">
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">Acme Products</p>
                        </div>
                      ...
                      <div className="flex justify-between items-center p-2 bg-muted rounded-md">
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">Globex Products</p>
                        </div>
                        <span className="text-xs px-2 py-1 rounded-full bg-green-100 text-green-800">
            ...
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>Training for equipment handling and setup</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-sm space-y-4">
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between items-center p-2 bg-muted rounded-md">
                        <div>
                          <span className="font-medium">Michael Chen</span>
                          <p className="text-xs text-muted-foreground">Trade Show Kit</p>
                        </div>
                        <span className="text-xs px-2 py-1 rounded-full bg-green-100 text-green-800">
                      ...
                      <div className="flex justify-between items-center p-2 bg-muted rounded-md">
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">All Kit Types</p>
                        </div>
                        <span className="text-xs px-2 py-1 rounded-full bg-green-100 text-green-800">
        ...
        <TabsContent value="availability" className="space-y-6">
          ...
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <h3 className="text-lg font-medium">Staff Availability Calendar</h3>
              <p className="text-muted-foreground max-w-md mt-2">
                This section will display staff availability for scheduling and assignment.
              </p>
            </div>
          </div>
        </TabsContent>
        ...
        <TabsContent value="timesheets" className="space-y-6">
          ...
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <p className="text-muted-foreground max-w-md mt-2">
                This section will display timesheet data, hours worked, and payroll information.
              </p>
            </div>
          </div>
        </TabsContent>
        ...
        <TabsContent value="reports" className="space-y-6">
          <p className="text-muted-foreground">
            Generate reports on staff performance, certifications, and attendance.
          </p>
          ...
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <p className="text-muted-foreground max-w-md mt-2">
                This section will allow generation of various staff-related reports.
              </p>
            </div>
          </div>
        </TabsContent>
