...
const BrandAgentCard = ({ agent, onAction }: { agent: BrandAgent; onAction: (action: string, agentId: string) => void }) => {
      ...
      <CardHeader className="pb-4">
        <div className="flex items-start justify-between">
          ...
          <div className="flex flex-col items-end space-y-1">
            ...
            <Badge className={`${getAvailabilityColor(agent.availability)} border text-xs`}>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-blue-600">{agent.eventsCompleted}</div>
            <div className="text-xs text-muted-foreground">Completed</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-orange-600">{agent.activeEvents}</div>
            <div className="text-xs text-muted-foreground">Active</div>
          </div>
          <div className="text-center">
            <div className={`text-2xl font-bold ${getRatingColor(agent.rating)}`}>{agent.rating}</div>
        ...
        <div className="flex space-x-2 pt-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent>
              ...
              <DropdownMenuItem onClick={() => onAction('performance', agent.id)}>
                Performance Review
              </DropdownMenuItem>
...
export default function BrandAgentsPage() {
  ...
  const availableAgents = brandAgents.filter(a => a.availability === 'available').length;
  const averageRating = (brandAgents.reduce((sum, a) => sum + a.rating, 0) / totalAgents).toFixed(1);
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600">{availableAgents}</p>
              </div>
