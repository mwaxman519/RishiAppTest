...
export default function EditBookingPage({ params }: { params: { id: string } }) {
    ...
    const fetchBooking = async () => {
      ...
      try {
        ...
        const mockBooking = {
          ...
          isRecurring: false,
          notes: "Development mode - using mock booking data. This booking is generated for testing purposes only.",
  ...
  const handleSubmit = async (data: any) => {
    try {
      ...
      if (!response.ok) {
        ...
        if (process.env.NODE_ENV === 'development') {
          ...
          toast({
            ...
            description: "The booking has been updated successfully in development mode.",
          })
      ...
      toast({
        title: "Update failed",
        description: err.message || "Failed to update booking. Please try again.",
        variant: "destructive"
      })
    }
  }
        ...
        <div className="container mx-auto py-6">
          <div className="flex items-center justify-center h-64">
            <div className="animate-pulse text-center">
              ...
              <p className="text-muted-foreground dark:text-gray-400">Loading booking details...</p>
            </div>
          </div>
        </div>
      </AppLayout>
      ...
      <AppLayout>
        <div className="container mx-auto py-6">
          <Alert variant="destructive" className="mb-6">
            ...
            <AlertDescription>
              {error || "Unable to load booking details. The booking may have been deleted."}
            </AlertDescription>
          </Alert>
          <Button 
    ...
    <AppLayout>
      <div className="container mx-auto py-6">
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold tracking-tight dark:text-white">Edit Booking</h1>
            ...
            <>
              ...
              {process.env.NODE_ENV === 'development' && (
                <div className="mb-4 p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                  <h3 className="text-sm font-medium text-yellow-800 dark:text-yellow-400">Debug Information</h3>
              ...
              <div className="mb-6 flex items-center">
                ...
                <div className="ml-3">
                  <h3 className="text-base font-medium text-gray-900 dark:text-gray-100">Editing Booking</h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    Make changes to the booking details below. All fields are required unless marked as optional.
                  </p>
                </div>
              </div>
