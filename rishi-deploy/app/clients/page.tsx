...
import { Building, Users, MapPin, CreditCard, Layers, Store } from "lucide-react";
      ...
      <Tabs defaultValue="directory" className="w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card className="transition-all hover:shadow-md">
              <CardHeader className="pb-3">
                ...
                <CardDescription>Tier 2 - Full-service event staffing</CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <TabsContent value="profile">
          <div className="flex items-center justify-center h-64">
            <p className="text-muted-foreground">Select a client from the directory to view and edit their profile.</p>
          </div>
        </TabsContent>
        
        <TabsContent value="brands">
          <div className="flex items-center justify-center h-64">
            <p className="text-muted-foreground">Select a client to manage their brands.</p>
          </div>
        </TabsContent>
        
        <TabsContent value="locations">
          <div className="flex items-center justify-center h-64">
            <p className="text-muted-foreground">Select a client to manage their locations and venues.</p>
          </div>
        </TabsContent>
        
        <TabsContent value="users">
          <div className="flex items-center justify-center h-64">
            <p className="text-muted-foreground">Select a client to manage their user accounts.</p>
          </div>
        </TabsContent>
        
        <TabsContent value="billing">
          <div className="flex items-center justify-center h-64">
            <p className="text-muted-foreground">Select a client to view and manage billing information.</p>
          </div>
        </TabsContent>
      </Tabs>
    </div>
