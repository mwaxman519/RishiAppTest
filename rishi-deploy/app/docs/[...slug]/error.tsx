    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] p-4">
      <Card className="w-full max-w-3xl">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl text-red-600">Documentation Error</CardTitle>
          <CardDescription>
        ...
        <CardContent>
          ...
          <div className="mt-4">
            <p>The documentation system encountered an error while trying to render this page. This could be due to:</p>
