...
export interface EventBus {
  publish(eventType: string, payload: any, metadata?: Partial<EventMetadata>): Promise<void>;
  subscribe(eventType: string, handler: (event: any) => void | Promise<void>): () => void;
}
...
export const eventBus: EventBus = {
  async publish(eventType: string, payload: any, metadata?: Partial<EventMetadata>): Promise<void> {
