...
export class OrganizationAwareRepository {
   ...
   */
  async getOrganization(organizationId: number): Promise<Organization | undefined> {
...
export class UserRepository extends OrganizationAwareRepository {
   ...
   */
  async getUser(userId: number, context: OrganizationContext): Promise<User | undefined> {
   ...
   */
  async createUser(userData: InsertUser, context: OrganizationContext): Promise<User> {
   ...
   */
  async updateUser(userId: number, userData: Partial<InsertUser>, context: OrganizationContext): Promise<User | undefined> {
...
export class PermissionRepository extends OrganizationAwareRepository {
  ...
  async updateOrganizationPermission(
    ...
    if (!existingPermission || existingPermission.organizationId !== context.organizationId) {
      return undefined;
    }
