...
export function BookingFormNew({ initialValues, editMode = false, onSubmit, onCancel }: BookingFormProps) {
  ...
  const formCompletion = () => {
    const requiredFields = [
      'title', 'location', 'date', 'startTime', 
      'endTime', 'attendeeEstimate', 'activityType'
    ]
                      ...
                      <div className="space-y-4">
                        ...
                        {isRecurring && (
                          <Card className="border dark:border-gray-800">
                            <CardHeader>
                              ...
                              <CardDescription>Define how often this event should repeat</CardDescription>
                            </CardHeader>
                            <CardContent>
                              <RecurrenceForm />
                            </CardContent>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem className="flex flex-row items-center justify-between rounded-md border dark:border-gray-800 p-4">
                              <div className="space-y-0.5">
                                <FormLabel className="text-base">Send Calendar Invites</FormLabel>
                                <FormDescription>
