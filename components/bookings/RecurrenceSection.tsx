...
import { recurrenceEngine, RecurrenceFrequency, RecurrencePattern } from "@/app/services/recurrence-engine";
        ...
        <div className="mt-4">
          ...
          <div className="flex flex-wrap gap-2">
            {occurrences.slice(0, 8).map((occurrence, index) => (
              <Badge 
                key={index}
                variant={occurrence.isException ? "outline" : (index === 0 ? "default" : "secondary")}
                className={occurrence.isException ? "line-through opacity-70" : ""}
              >
