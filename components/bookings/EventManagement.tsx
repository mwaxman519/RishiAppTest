...
import { useEventInstances, useAssignEventManager, EventInstance } from '@/hooks/use-event-instances';
...
export default function EventManagement({ bookingId, managers = [] }: EventManagementProps) {
      ...
      <CardContent>
        {isLoading ? (
          ...
          <EventInstancesList 
            ...
            onViewDetails={(eventId: string) => console.log('View details:', eventId)}
          />
        )}
      </CardContent>
          ...
          <div className="py-4 space-y-4">
            <div>
              ...
              <p className="font-medium">
                {getSelectedEvent()?.date && new Date(getSelectedEvent()?.date!).toLocaleDateString('en-US', {
                  weekday: 'long',
                  year: 'numeric',
                  month: 'long',
                  day: 'numeric'
