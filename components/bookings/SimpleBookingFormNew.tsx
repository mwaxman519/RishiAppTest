...
export function SimpleBookingFormNew({ onSubmit, onCancel }: SimpleBookingFormProps) {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-lg border dark:border-gray-800 shadow-sm">
      <div className="p-6 border-b dark:border-gray-800">
        <h1 className="text-2xl font-bold dark:text-white">New Booking (Simplified)</h1>
