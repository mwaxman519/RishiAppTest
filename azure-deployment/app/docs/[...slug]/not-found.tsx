      ...
      <Card className="w-full max-w-3xl">
        ...
        <CardContent>
            ...
            <div className="mt-6">
              ...
              <ul className="space-y-2">
                {suggestions.map((suggestion, index) => (
                  <li key={index} className="p-2 bg-muted/50 rounded hover:bg-muted transition-colors">
                    <Link 
                      href={suggestion}
          ...
          <div className="mt-8 text-sm text-muted-foreground">
            <p>If you believe this is an error, please report it to the development team.</p>
          </div>
        </CardContent>
