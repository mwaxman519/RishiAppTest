...
import { Clock, Play, Pause, Square, Calendar, MapPin, User } from 'lucide-react';
...
export default function TimeTrackingPage() {
  ...
  const stopTracking = () => {
    if (currentSession) {
      ...
      const newEntry = {
        ...
        startTime: currentSession.startTime.toLocaleTimeString('en-US', { hour12: false }),
  ...
  const totalHoursThisWeek = timeEntries.reduce((total, entry) => total + entry.duration, 0);
    ...
    <div className="container mx-auto p-6 max-w-7xl">
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>
            {isTracking ? 'Currently tracking time' : 'Start tracking your work session'}
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {timeEntries.length > 0 ? Math.round((totalHoursThisWeek / timeEntries.length) * 100) / 100 : 0}h
            </div>
