    ...
    <div className="container mx-auto py-6 space-y-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Activate and manage locations for your brands to make them available in booking portals.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {brandsLoading ? (
            ...
            <div className="py-8 text-center">
              ...
              <p className="text-muted-foreground max-w-md mx-auto">
                You don't have any brands configured. Please contact your administrator.
              </p>
            </div>
          ) : (
            <>
              ...
              {selectedBrandId || brands[0]?.id ? (
                <GoogleMapsProvider>
                  <ClientLocationsList brandId={selectedBrandId || brands[0]?.id} />
                </GoogleMapsProvider>
              ) : (
                <div className="py-6 text-center">
                  <p className="text-muted-foreground">Please select a brand to manage locations</p>
                </div>
              )}
            </>
          )}
