...
export default function RBACSettingsPage() {
  ...
  const loadSettings = async () => {
    try {
      const response = await fetch(`/api/organizations/${organizationId}/feature-settings`);
      if (response.ok) {
        ...
        const featureSettings: FeatureSetting[] = [
          {
            ...
            description: 'Allow brand agents to view all organizational events, not just their assigned ones',
            category: 'Events',
          ...
          },
          {
            ...
            description: 'Allow brand agents to update their own availability and schedule preferences',
            category: 'Events',
          ...
          },
          {
            ...
            description: 'Allow field coordinators to approve or reject event assignments',
            category: 'Events',
          ...
          },
          {
            ...
            description: 'Allow client users to create new events for their organization',
            category: 'Events',
          ...
          },
          {
            ...
            description: 'Send notifications for event updates, assignments, and changes',
            category: 'System',
  ...
  return (
    <div className="container mx-auto p-6 max-w-4xl">
      ...
      <p className="text-muted-foreground mb-8">
        Configure role-based access control settings for your organization. These settings control what actions different user roles can perform.
      </p>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-orange-700 dark:text-orange-300 mt-1">
                Changes to RBAC settings take effect immediately. Users may need to refresh their browser to see updated permissions.
              </p>
            </div>
          </div>
        </CardContent>
