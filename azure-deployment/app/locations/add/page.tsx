  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      ...
      <p className="text-muted-foreground">
        Submit a new location for approval. Once approved, it will be available for booking and scheduling.
      </p>
      ...
      <Alert className="bg-primary/5 border-primary/20 mb-6">
        ...
        <AlertDescription>
          Search for addresses or businesses, use your current location, or click directly on the map to select a location.
        </AlertDescription>
      </Alert>
                  ...
                  <ManualAddressEntry 
                    onLocationSelect={(locationData) => {
                      ...
                      const place = {
                        ...
                        place_id: '',
                        name: locationData.name || formattedAddress.split(',')[0]
                      };
