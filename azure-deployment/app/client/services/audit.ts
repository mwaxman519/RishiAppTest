...
export class AuditServiceClient {
   ...
   * @returns Audit logs array and total count
   */
  async getUserAuditLogs(userId: string, params: Omit<AuditLogQueryParams, 'userId'> = {}): Promise<{ logs: AuditLogEntry[], total: number }> {
   ...
   * @returns Audit logs array and total count
   */
  async getOrganizationAuditLogs(organizationId: string, params: Omit<AuditLogQueryParams, 'organizationId'> = {}): Promise<{ logs: AuditLogEntry[], total: number }> {
