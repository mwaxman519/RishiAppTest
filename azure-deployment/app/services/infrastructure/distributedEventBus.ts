...
export interface EventPublisher {
  publish<E extends AppEvent>(event: E, payload: PayloadFor<E>, options?: any): Promise<boolean>;
}

// Event subscriber interface
export interface EventSubscriber {
  subscribe<E extends AppEvent>(event: E, handler: (payload: PayloadFor<E>, metadata?: any) => void): void;
  unsubscribe<E extends AppEvent>(event: E, handler: (payload: PayloadFor<E>, metadata?: any) => void): void;
}
...
class LocalEventBus implements EventBus {
  private handlers: Map<string, Array<(payload: any, metadata?: any) => void>> = new Map();
