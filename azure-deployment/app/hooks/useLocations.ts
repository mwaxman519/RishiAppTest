...
export function useLocations(filters: LocationFilters = {}): {
  ...
  updateLocation: (params: { id: string, data: UpdateLocationParams }) => Promise<LocationDTO>;
  deleteLocation: (id: string) => Promise<void>;
  approveLocation: (id: string) => Promise<LocationDTO>;
  rejectLocation: (params: { id: string, reason?: string | undefined }) => Promise<LocationDTO>;
  createMutation: any;
  updateMutation: any;
  deleteMutation: any;
  approveMutation: any;
  ...
  const createMutation = useMutation({
    mutationFn: (data: CreateLocationParams) => locationsClient.createLocation(data),
    onSuccess: () => {
      toast({
        title: 'Success',
