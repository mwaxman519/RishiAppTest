...
import { insertBookingSchema, InsertBooking, BOOKING_PRIORITY, BOOKING_STATUS } from "@/shared/schema";
import { RecurrencePattern, RecurrenceFrequency, RecurrenceDays, formatRecurrencePattern } from "@/lib/recurrence";
  ...
  const onSubmit = async (values: BookingFormValues) => {
    try {
      ...
      const bookingData: InsertBooking = {
        ...
        isRecurring,
        recurrencePattern: recurrencePattern ? formatRecurrencePattern(recurrencePattern) : null,
      ...
      >
        <TabsList className="grid w-full grid-cols-3">
          ...
          <TabsTrigger value="preview">
            Preview
            {isRecurring && <Badge variant="outline" className="ml-2">Series</Badge>}
          </TabsTrigger>
        </TabsList>
            ...
            <TabsContent value="recurrence" className="space-y-6 py-4">
              ...
              {isRecurring && (
                <Alert>
                  ...
                  <AlertDescription>
                    This booking will generate multiple events according to your recurrence pattern. 
                    You can see a preview in the next tab.
                  </AlertDescription>
                </Alert>
              )}
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1">
                        ...
                        <p className="text-sm">
                          {organizations.find(o => o.id === form.watch("clientOrganizationId"))?.name || "Not specified"}
                        </p>
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-sm">
                          {activityTypes.find(t => t.id === form.watch("activityTypeId"))?.name || "Not specified"}
                        </p>
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-sm">
                          {form.watch("budget") ? `$${form.watch("budget").toFixed(2)}` : "Not specified"}
                        </p>
                      </div>
                      ...
                      <div className="space-y-1">
                        <h4 className="text-sm font-medium">Estimated Attendees</h4>
                        <p className="text-sm">
