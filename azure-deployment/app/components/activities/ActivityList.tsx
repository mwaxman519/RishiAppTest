...
import { Calendar, Clock, Edit, MapPin, MoreHorizontal, Plus, Trash } from "lucide-react";
...
export function ActivityList({
  ...
  return (
    <div className="space-y-6">
              ...
              <div className="space-y-2">
                {dateActivities.map(activity => (
                  <ActivityCard 
                    key={activity.id} 
                    activity={activity}
                    activityType={activityTypes[activity.typeId]?.name || "Activity"}
      ...
      <AlertDialog open={!!activityToDelete} onOpenChange={(open) => !open && handleCancelDelete()}>
        <AlertDialogContent>
          <AlertDialogHeader>
...
function ActivityCard({ activity, activityType, onEdit, onDelete }: ActivityCardProps) {
