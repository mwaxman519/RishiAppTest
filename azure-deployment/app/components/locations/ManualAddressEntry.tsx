...
export default function ManualAddressEntry({ onLocationSelect, onToggleSearchMode }: ManualAddressEntryProps) {
  ...
  const onSubmit = async (data: AddressFormValues) => {
    ...
    try {
      ...
      const selectedState = states.find(state => state.abbreviation === data.state);
      ...
      try {
        const response = await fetch(`/api/locations/geocode?address=${encodeURIComponent(
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="flex space-x-2">
            ...
            <Button type="button" variant="outline" onClick={onToggleSearchMode}>
              Try Search Instead
            </Button>
          </div>
        </form>
