...
export default function AddLocationForm() {
  ...
  const updateFormFromPlace = (place: google.maps.places.PlaceResult | google.maps.GeocoderResult) => {
    let street = '';
    let city = '';
    let state = '';
    let zipCode = '';
    ...
    if (!form.getValues('name') && place.formatted_address) {
      form.setValue('name', place.name || place.formatted_address.split(',')[0]);
    }
  };
      ...
      <Card className="w-full">
        ...
        <CardContent>
          <Alert variant="default" className="mb-4 bg-green-50 border-green-200">
            ...
            <AlertDescription>
              Your location request has been submitted for review by an administrator. You'll be notified when it's approved or if additional information is needed.
            </AlertDescription>
          </Alert>
          ...
          <dl className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <dd className="capitalize">{form.getValues('locationType').replace('_', ' ')}</dd>
            </div>
          </dl>
        </CardContent>
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Submit a new location or service area for approval. Once approved, it can be used for bookings.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="mb-6">
            <Alert variant="info" className="mb-4">
              ...
              <AlertDescription>
                Submitted locations require approval before they can be used in booking portals. 
                Please provide accurate information to expedite the review process.
              </AlertDescription>
            </Alert>
          </div>
            ...
            <div className="space-y-8">
              <div>
                <div className="rounded-lg overflow-hidden">
                  ...
                  <div id="location-map" className="w-full h-[400px] rounded-lg border"></div>
                </div>
                
                <p className="text-sm text-muted-foreground mt-2">
                  Search for a location or drag the pin to position it precisely.
                </p>
              </div>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Include any important details that might help during the approval process.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
