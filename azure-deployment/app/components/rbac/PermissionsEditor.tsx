...
import { UserRole, Permission, getAllPermissions, getPermissionsForRole } from '../../lib/rbac';
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-4">
        {Object.entries(permissionsByResource).map(([resource, permissions]) => (
          <div key={resource} className="border border-gray-200 dark:border-gray-700 rounded-md overflow-hidden">
