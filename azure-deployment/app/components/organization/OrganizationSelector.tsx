...
import { useOrganization, UserOrganization } from '@/contexts/OrganizationProvider';
...
export function OrganizationSelector({ className }: OrganizationSelectorProps) {
  const { userOrganizations, currentOrganization, switchOrganization, isLoading } = useOrganization();
      ...
      <DropdownMenu open={open} onOpenChange={setOpen}>
          ...
          >
            <div className="flex items-center flex-1 space-x-2 overflow-hidden">
              <Avatar className="h-5 w-5">
                <AvatarImage src={`https://avatar.vercel.sh/${currentOrganization.id}.png`} alt={currentOrganization.name} />
        ...
        <DropdownMenuContent align="start" className="w-[250px]">
                  ...
                  <div className="flex items-center w-full">
                    ...
                    <div className="flex-1 truncate">
                      ...
                      <div className="flex items-center space-x-1 mt-0.5">
                        <span className={`text-xs ${styles.textColor}`}>{org.type}</span>
          ...
          <DropdownMenuItem asChild>
            <a href="/settings/organizations" className="cursor-pointer flex w-full items-center">
