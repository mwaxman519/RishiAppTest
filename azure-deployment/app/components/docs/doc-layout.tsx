...
export function DocLayout({ children, docTree, currentPath, metadata }: DocLayoutProps) {
    ...
    <div className="flex min-h-screen max-w-screen-2xl mx-auto">
      ...
      <div 
        className={`fixed inset-0 bg-black/50 z-[90] transition-opacity duration-300 ${
          mobileNavOpen || appNavOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'
        }`}
        onClick={() => {
      ...
      `}>
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-800 bg-gradient-to-r from-purple-100 to-teal-50 dark:from-purple-900/40 dark:to-teal-900/20">
          <div className="flex-1 flex items-center overflow-hidden">
            ...
            <span className="ml-2 font-semibold text-lg bg-gradient-to-r from-purple-600 to-teal-500 bg-clip-text text-transparent truncate">Documentation</span>
          </div>
          <button
        ...
        <div className="overflow-y-auto h-[calc(100vh-116px)]">
          {activeNav === 'docs' ? (
            <div className="p-4">
              ...
              {/* Doc tree navigation */}
              <TableOfContents tree={docTree} onLinkClick={() => setMobileNavOpen(false)} />
            </div>
          ) : (
            <div className="p-4">
              {/* App-wide navigation */}
      ...
      <aside className="hidden lg:block w-72 sticky top-0 h-screen border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950">
        <div className="flex justify-between items-center px-5 py-4 border-b border-gray-200 bg-gradient-to-r from-purple-100 to-teal-50 dark:from-purple-900/40 dark:to-teal-900/40 dark:border-gray-800">
          <Link href="/" className="flex items-center space-x-2">
            ...
            <span className="font-semibold text-lg bg-gradient-to-r from-purple-600 to-teal-500 bg-clip-text text-transparent">Documentation</span>
          </Link>
        </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <footer className="mt-16 pt-8 border-t border-gray-200 text-sm text-gray-500 dark:border-gray-800 dark:text-gray-400">
                  ...
                  <div className="flex items-center">
                    <div className="w-5 h-5 rounded-full bg-[rgba(var(--primary),0.15)] flex items-center justify-center mr-2">
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9 5H7C5.89543 5 5 5.89543 5 7V19C5 20.1046 5.89543 21 7 21H17C18.1046 21 19 20.1046 19 19V7C19 5.89543 18.1046 5 17 5H15" stroke="rgb(var(--primary))" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M12 12V3M12 3L9 6M12 3L15 6" stroke="rgb(var(--primary))" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </div>
                    <p>Last updated: <span className="font-medium text-gray-700 dark:text-gray-300">{metadata.lastUpdated?.toLocaleDateString() || 'Unknown'}</span></p>
                  </div>
                  <div className="mt-4 md:mt-0 flex space-x-6">
                    <Link href="#" className="flex items-center text-purple-600 hover:text-purple-700 dark:text-purple-400 dark:hover:text-purple-300 transition-colors">
                      <svg className="w-4 h-4 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                      </svg>
                      Edit this page
                    </Link>
                    <Link href="#" className="flex items-center text-teal-600 hover:text-teal-700 dark:text-teal-400 dark:hover:text-teal-300 transition-colors">
                      <svg className="w-4 h-4 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="bg-gradient-to-r from-purple-50 to-teal-50 dark:from-purple-950/30 dark:to-teal-950/30 rounded-lg p-6 flex flex-col md:flex-row items-start md:items-center justify-between border border-purple-100/50 dark:border-purple-800/20">
                  <div>
                    <h3 className="text-base font-medium bg-gradient-to-r from-purple-700 to-teal-600 bg-clip-text text-transparent dark:from-purple-400 dark:to-teal-300 mb-1">Did this documentation help you?</h3>
                    <p className="text-gray-600 dark:text-gray-400">We're always looking to improve our documentation.</p>
                  </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-30 bg-white dark:bg-gray-950 border-t border-gray-200 dark:border-gray-800 lg:hidden">
        <div className="flex items-center justify-around py-2">
          ...
          <button
            ...
            className="flex flex-col items-center p-2 text-gray-600 dark:text-gray-400"
          >
            <svg className="h-6 w-6 dark:hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {/* Mobile TOC Drawer */}
      <MobileTocDrawer isOpen={tocDrawerOpen} onClose={() => setTocDrawerOpen(false)} />
      ...
      `}>
        ...
        <div className="overflow-y-auto h-[calc(100vh-64px)] p-4">
          <TableOfContents tree={docTree} onLinkClick={() => setMobileDocsOpen(false)} />
        </div>
      </div>
    </div>
  );
