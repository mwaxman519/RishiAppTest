            ...
            >
              <a
                ...
                className={cn(
                  ...
                  activeId === heading.id && "bg-gradient-to-r from-purple-100 to-teal-50 text-purple-700 font-medium dark:from-purple-900/20 dark:to-teal-900/20 dark:text-teal-300 dark:border dark:border-teal-800/40"
                )}
                onClick={(e) => {
                  e.preventDefault();
