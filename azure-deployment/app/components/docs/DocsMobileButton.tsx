...
export function DocsMobileButton({ docTree }: DocsMobileButtonProps) {
  ...
  const isValidTree = docTree && typeof docTree === 'object' && Object.keys(docTree).length > 0;
            ...
            <div className="space-y-4 px-2">
              <div className="p-3 bg-amber-50 dark:bg-amber-950 border border-amber-200 dark:border-amber-800 rounded-md">
                <div className="flex items-start gap-2 text-amber-700 dark:text-amber-400">
                  ...
                  <div>
                    <p className="text-sm font-medium">Documentation tree is empty</p>
                    <p className="text-xs mt-1">No documentation structure was found or loaded.</p>
                  </div>
                </div>
              </div>
