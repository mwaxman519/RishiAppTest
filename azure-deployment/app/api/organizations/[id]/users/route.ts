  ...
  try {
    ...
    if (user.id === '123e4567-e89b-12d3-a456-426614174000') {
      ...
      return NextResponse.json({
        users: [
          { id: '123e4567-e89b-12d3-a456-426614174000', username: 'dev_user', name: 'Development User', role: 'super_admin' },
          { id: '223e4567-e89b-12d3-a456-426614174001', username: 'client_admin', name: 'Client Admin', role: 'client_admin' },
          { id: '323e4567-e89b-12d3-a456-426614174002', username: 'client_user', name: 'Client User', role: 'client_user' },
        ]
      });
    }
