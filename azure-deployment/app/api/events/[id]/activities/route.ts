...
const mockActivities = {
  '1': [
    {
      ...
      description: 'Arrange promotional materials and set up product demonstration stations',
      status: 'scheduled',
    ...
    },
    {
      ...
      description: 'Review promotional goals, product features, and staff assignments',
      status: 'scheduled',
    ...
    },
    {
      ...
      endTime: new Date(Date.now() + 86400000 + 7200000 - 1800000).toISOString(), // Until 30 min before end
      assignedTo: {
        id: 'user2',
    ...
    },
    {
      ...
      status: 'scheduled',
      startTime: new Date(Date.now() + 86400000 + 7200000 - 1800000).toISOString(), // 30 min before end
  ...
  '2': [
    ...
    },
    {
      ...
      description: 'Remove old displays and prepare area for new seasonal setup',
      status: 'scheduled',
    ...
    },
    {
      ...
      description: 'Install and arrange new seasonal displays per brand guidelines',
      status: 'scheduled',
  ...
  '3': [
    ...
    },
    {
      ...
      description: 'In-depth training on merchandising techniques and standards',
      status: 'completed',
  ...
  '4': [
    ...
    },
    {
      ...
      description: 'Update and refresh product displays and promotional materials',
      status: 'in_progress',
  ...
  '5': [
    {
      ...
      eventId: '5',
      title: 'Venue Setup',
      description: 'Prepare venue with branding, displays, and sampling stations',
      status: 'scheduled',
