...
import { Package, Boxes, Tags, ArrowRight, Wrench, Clipboard, Activity } from 'lucide-react';


export const metadata: Metadata = {
  title: 'Kit Management | Rishi Platform',
  description: 'Manage kit templates, instances, inventory, and assignments for field operations',
};
    ...
    <div className="container mx-auto py-6 space-y-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Manage your kit templates, instances, and assignments for field operations
            </p>
          </div>
        </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <Card className="flex flex-col">
          ...
          <CardContent className="flex-grow">
            <p className="text-sm text-muted-foreground">
              Create and manage standardized templates for your kits with detailed component lists. 
              Define what goes into each kit type and set standards for equipment, tools, and materials.
            </p>
          </CardContent>
          <CardFooter>
        ...
        <Card className="flex flex-col">
          ...
          <CardContent className="flex-grow">
            <p className="text-sm text-muted-foreground">
              ...
              Track location, status, and usage history of each physical kit in the field.
            </p>
          </CardContent>
          <CardFooter>
        ...
        <Card className="flex flex-col">
          ...
          <CardContent className="flex-grow">
            <p className="text-sm text-muted-foreground">
              Manage inventory levels for kit components. Set up alerts for low stock levels
              and generate purchase orders for replenishment.
            </p>
          </CardContent>
          <CardFooter>
        ...
        <Card className="flex flex-col">
          ...
          <CardContent className="flex-grow">
            <p className="text-sm text-muted-foreground">
              Set up maintenance schedules for equipment and tools. 
              Record maintenance history and receive alerts for upcoming maintenance needs.
            </p>
          </CardContent>
          <CardFooter>
            <Button disabled variant="outline" className="w-full">
        ...
        <Card className="flex flex-col">
          ...
          <CardContent className="flex-grow">
            <p className="text-sm text-muted-foreground">
              Generate reports on kit utilization, component usage, maintenance history,
              and other key metrics to optimize your kit management.
            </p>
          </CardContent>
          <CardFooter>
            <Button disabled variant="outline" className="w-full">
