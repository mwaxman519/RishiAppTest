...
const AgentAvailabilityView = memo(function AgentAvailabilityView({
  ...
  const [editingBlock, setEditingBlock] = useState<AvailabilityDTO | null>(null);
              ...
              <ErrorBoundary
                errorComponent={(error, reset) => (
                  <div className="p-4 border border-red-300 rounded bg-red-50 text-red-700">
                    ...
                    <p className="mb-2">{error.message || 'An error occurred while loading the calendar'}</p>
                    <button 
                      onClick={reset}
              ...
              >
                <CalendarProvider userId={userId}>
                  ...
                  <div className="bg-gray-100 dark:bg-gray-800 rounded p-4 text-center">
                    <p>Calendar view has been migrated to the main availability page.</p>
                  </div>
                </CalendarProvider>
              </ErrorBoundary>
            </div>
              ...
              <ErrorBoundary
                errorComponent={(error, reset) => (
                  <div className="p-4 border border-red-300 rounded bg-red-50 text-red-700">
                    ...
                    <p className="mb-2">{error.message || 'An error occurred while loading the edit form'}</p>
            ...
            <div className="mb-6">
              ...
              <ErrorBoundary
                errorComponent={(error, reset) => (
                  <div className="p-4 border border-red-300 rounded bg-red-50 text-red-700">
                    <h3 className="font-bold mb-2">Form Error</h3>
                    <p className="mb-2">{error.message || 'An error occurred while loading the availability form'}</p>
                    <button 
                      onClick={reset}
                      className="px-3 py-1 bg-red-600 text-white rounded hover:bg-red-700"
                    >
