      ...
      {activeTab === 'team' && (
        <div>
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-lg font-semibold">Team Availability Overview</h2>
            <Link 
          ...
          <p className="text-gray-600 mb-6">
            View and manage availability for your team members. Use the detailed team view for more options.
          </p>
          ...
          <div className="bg-gray-50 p-6 rounded-lg mb-6">
            ...
            <p className="text-gray-500">Team availability overview will be displayed here.</p>
