...
export default function DeactivateTeamMemberPage({ params }: DeactivateTeamMemberProps) {
  const { id } = use(params);
    ...
    return (
      <div className="container mx-auto p-6">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-muted-foreground">Team Member Not Found</h1>
          <Link href="/team">
  ...
  const handleDeactivate = async () => {
    ...
    if (deactivationData.reason === 'other' && !deactivationData.customReason.trim()) {
      toast({
    ...
    if (!deactivationData.confirmDeactivation) {
      toast({
        ...
        description: 'Please confirm that you want to deactivate this team member.',
        variant: 'destructive',
      });
      return;
    }
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Alert variant="destructive">
        ...
        <AlertDescription>
          Deactivating this team member will remove their access to the system and may affect ongoing assignments and events.
        </AlertDescription>
      </Alert>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Select value={deactivationData.reason} onValueChange={(value) => handleInputChange('reason', value)}>
                  <SelectTrigger>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleInputChange('transferAssignments', checked as boolean)}
                />
                <Label htmlFor="transferAssignments">Transfer assignments to another team member</Label>
              </div>

              {deactivationData.transferAssignments && (
                <div className="space-y-2">
                  <Label htmlFor="transferTo">Transfer To</Label>
                  <Select value={deactivationData.transferTo} onValueChange={(value) => handleInputChange('transferTo', value)}>
                    <SelectTrigger>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <div className="mt-2 text-sm text-yellow-700">
                  <p>• {member.upcomingEvents} upcoming events will be affected</p>
                  <p>• {member.activeAssignments} active assignments need to be reassigned</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleInputChange('notifyMember', checked as boolean)}
                />
                <Label htmlFor="notifyMember">Send deactivation notice to team member</Label>
              </div>
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleInputChange('finalPayroll', checked as boolean)}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleInputChange('returnEquipment', checked as boolean)}
                />
                <Label htmlFor="returnEquipment">Collect company equipment</Label>
              </div>
            </CardContent>
          </Card>
        </div>
            ...
            <CardContent>
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleInputChange('confirmDeactivation', checked as boolean)}
                />
                <Label htmlFor="confirmDeactivation" className="text-sm">
                  I understand this action cannot be undone and confirm I want to deactivate this team member
                </Label>
              </div>
            </CardContent>
          </Card>
