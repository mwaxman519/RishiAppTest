...
export async function sendEmail(params: SendEmailParams): Promise<boolean> {
  ...
  if (process.env.NODE_ENV === 'development') {
    ...
    if (params.cc) console.log(`CC: ${Array.isArray(params.cc) ? params.cc.join(', ') : params.cc}`);
    if (params.bcc) console.log(`BCC: ${Array.isArray(params.bcc) ? params.bcc.join(', ') : params.bcc}`);
