                  ...
                  <CardContent>
                    <div className="space-y-2">
                      ...
                      <div>
                        ...
                        <p>{event.location?.address || 'No address available'}</p>
                      </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <h4 className="text-sm font-medium mb-1">Expected Attendees</h4>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div>
                        ...
                        <p className="capitalize">{event.recurringPattern || 'Not specified'}</p>
                      </div>
              ...
              {isLoadingStaff ? (
                ...
                <div className="space-y-4">
                  {staffAssignments.map((staff: any) => (
                    <div key={staff.id} className="flex items-center justify-between p-4 border rounded-md">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="text-sm text-muted-foreground">{staff.role || 'No role specified'}</p>
                        </div>
                      </div>
