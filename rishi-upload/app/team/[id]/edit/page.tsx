...
import { ArrowLeft, Save, User, Mail, Phone, MapPin, Shield, Calendar } from 'lucide-react';
...
const getTeamMemberById = (id: string) => {
  const members = {
    '1': {
      ...
      notes: 'Excellent performance in corporate events. Preferred for high-profile clients.'
    },
    '2': {
      id: '2',
      name: 'Michael Chen',
