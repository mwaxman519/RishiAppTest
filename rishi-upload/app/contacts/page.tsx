...
const contactsData = [
  ...
  },
  {
    ...
    preferredContact: 'email',
    timezone: 'CST',
    notes: 'Strategic partner for staff augmentation. Weekly check-ins scheduled.',
  ...
  },
  {
    ...
    preferredContact: 'phone',
    timezone: 'EST',
    notes: 'High-value client. Prefers direct communication for premium services.',
...
const ContactCard = ({ contact, onAction }: { contact: Contact; onAction: (action: string, contactId: string) => void }) => {
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="text-center bg-yellow-50 rounded-lg p-3">
            <div className={`text-lg font-bold ${getRatingColor(contact.rating)} flex items-center justify-center`}>
          ...
          <div className="text-center bg-blue-50 rounded-lg p-3">
            <div className="text-lg font-bold text-blue-600">{contact.interactions}</div>
        ...
        <div className="bg-gray-50 rounded-lg p-3">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">{formatLastContact(contact.lastContact)}</p>
            </div>
        ...
        <div className="flex space-x-2 pt-2 border-t">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent>
              <DropdownMenuItem onClick={() => onAction('schedule', contact.id)}>
                Schedule Meeting
              </DropdownMenuItem>
...
export default function ContactsPage() {
  ...
  const primaryContacts = contactsData.filter(c => c.type === 'primary').length;
  const executiveContacts = contactsData.filter(c => c.type === 'executive').length;
  const averageRating = (contactsData.reduce((sum, c) => sum + c.rating, 0) / totalContacts).toFixed(1);

  const uniqueOrganizations = [...new Set(contactsData.map(c => c.organization))];
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage and maintain relationships with key contacts across all organizations
          </p>
        </div>
        <Button>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600">{primaryContacts}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-600">{executiveContacts}</p>
              </div>
