...
const mockEvents = [
  {
    ...
    description: 'Introducing new product line with demonstrations and staff training',
  ...
  },
  {
    ...
    description: 'Implementing the summer promotional display across target locations',
    organizationId: '00000000-0000-0000-0000-000000000001',
    locationId: 'loc2',
    location: {
      id: 'loc2',
  ...
  },
  {
    ...
    description: 'Regular update of merchandising and restocking of promotional materials',
    organizationId: '00000000-0000-0000-0000-000000000001',
    locationId: 'loc4',
    location: {
      id: 'loc4',
  ...
  },
  {
    ...
    description: 'Customer engagement event with product sampling and giveaways',
    organizationId: '00000000-0000-0000-0000-000000000002',
    locationId: 'loc5',
    location: {
      id: 'loc5',
    ...
    notes: 'High-visibility event, ensure premium promotional materials are available'
  }
];
