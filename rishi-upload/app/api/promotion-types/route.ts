...
const SYSTEM_PROMOTION_TYPES = [
  { id: 'product_launch', name: 'Product Launch', description: 'Introducing new products to the market' },
  { id: 'seasonal', name: 'Seasonal Promotion', description: 'Promotions for seasonal events and holidays' },
  { id: 'brand_awareness', name: 'Brand Awareness', description: 'Activities focused on increasing brand recognition' },
  { id: 'sampling', name: 'Product Sampling', description: 'Distributing product samples to potential customers' },
  { id: 'special_event', name: 'Special Event', description: 'One-time or unique promotional events' }
];
