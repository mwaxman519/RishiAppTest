  ...
  try {
    ...
    if (process.env.NODE_ENV === 'development') {
      ...
      return NextResponse.json({
        activityTypes: [
          { id: "1", name: "Product Demo", description: "Demonstrate product features to potential customers" },
          { id: "2", name: "Product Sampling", description: "Provide product samples to potential customers" },
          { id: "3", name: "Brand Education", description: "Educate customers about the brand and products" },
          { id: "4", name: "Interactive Experience", description: "Create an interactive brand experience" }
        ],
        locations: [
          { 
            id: "1", 
        ...
        promotionTypes: [
          { id: "1", name: "Discount", description: "Offer a discount on products" },
          { id: "2", name: "BOGO", description: "Buy one, get one free" },
          { id: "3", name: "Loyalty Program", description: "Reward loyal customers" },
          { id: "4", name: "New Product Launch", description: "Introduce a new product" }
        ],
        kitTemplates: [
          { id: "1", name: "Standard Brand Kit", description: "Basic branding materials" },
          { id: "2", name: "Premium Experience Kit", description: "Enhanced brand experience materials" },
          { id: "3", name: "Event Specific Kit", description: "Materials tailored for specific events" }
        ]
      });
    }
    ...
    const isAdmin = ["super_admin", "internal_admin", "internal_field_manager"].includes(
      session?.user?.role || ""
    );
