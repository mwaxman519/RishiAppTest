...
export async function POST(
  ...
  try {
    ...
    try {
      ...
      console.log('[approve/route] Updated location to publish:', JSON.stringify(updatedLocation, null, 2));
      console.log('[approve/route] User approving location:', JSON.stringify(user, null, 2));
