...
export const GOOGLE_MAPS_ID = process.env.NEXT_PUBLIC_GOOGLE_MAPS_ID || "8bb5ff3cc2e55613"; // Default Map ID for advanced markers
...
export const getGoogleMapsOptions = (theme: string | undefined, zoom: number = 10, showControls: boolean = true) => ({
