...
export const recurrenceEngine = {
   ...
   */
  addException(pattern: RecurrencePattern, exceptionDate: Date): RecurrencePattern {
   ...
   */
  removeException(pattern: RecurrencePattern, exceptionDate: Date): RecurrencePattern {
  ...
  getPatternDescription(pattern: RecurrencePattern): string {
    const frequency = pattern.frequency.charAt(0).toUpperCase() + pattern.frequency.slice(1);
