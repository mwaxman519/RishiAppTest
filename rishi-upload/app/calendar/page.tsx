...
import { Calendar, ChevronLeft, ChevronRight, Plus, Filter, MapPin, Users, Clock, Star, TrendingUp, List, Grid } from 'lucide-react';
...
export default function CalendarPage() {
  ...
  const getBookingsForHour = (date: Date, hour: number) => {
    ...
    return dayBookings.filter(booking => {
      ...
      const adjustedHour = isPM && bookingHour !== 12 ? bookingHour + 12 : 
                          !isPM && bookingHour === 12 ? 0 : bookingHour;
    ...
    <AppLayout>
      <div className="space-y-6">
        <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Cannabis Operations Calendar</h1>
            ...
            <div className="lg:col-span-1">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    {getBookingsForDate(selectedDate).length} operations scheduled
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-1 max-h-96 overflow-y-auto">
                    {Array.from({ length: 24 }, (_, hour) => {
                      const hourBookings = getBookingsForHour(selectedDate, hour);
                      return (
                        <div key={hour} className="flex items-start space-x-3 py-1 border-b border-muted">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Total Cannabis Operations</CardTitle>
