      ...
      <Tabs defaultValue="calendar" className="w-full">
        <div className="flex justify-between items-center mb-1">
          <TabsList className="h-8">
            <TabsTrigger value="calendar" className="text-xs px-2 py-1 h-7">Calendar</TabsTrigger>
            <TabsTrigger value="upcoming" className="text-xs px-2 py-1 h-7">Upcoming Shifts</TabsTrigger>
            <TabsTrigger value="history" className="text-xs px-2 py-1 h-7">History</TabsTrigger>
            <TabsTrigger value="team" className="text-xs px-2 py-1 h-7">Team View</TabsTrigger>
          </TabsList>
        </div>
          ...
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <p className="text-muted-foreground max-w-md mt-2">
                This section will display your historical shifts and event participation.
              </p>
            </div>
          </div>
        </TabsContent>
        ...
        <TabsContent value="team" className="space-y-6">
          ...
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <p className="text-muted-foreground max-w-md mt-2">
                This section will provide a view of availability across all team members.
              </p>
            </div>
          </div>
        </TabsContent>
