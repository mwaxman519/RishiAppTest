  ...
  return (
    <div className="p-6">
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-blue-700">
              We're experiencing some technical issues with the calendar component. 
      ...
      <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
        ...
        <p className="mb-4">
          While we fix the calendar, here's a list of your current availability blocks.
        </p>
          ...
          <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Mon-Fri • 9:00 AM - 5:00 PM</p>
              </div>
              <span className="px-2 py-1 bg-teal-100 text-teal-800 text-xs rounded-full">Available</span>
            </div>
          </div>
          ...
          <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Mon-Fri • 12:00 PM - 1:00 PM</p>
              </div>
          ...
          <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Sat-Sun • 10:00 AM - 4:00 PM</p>
              </div>
              <span className="px-2 py-1 bg-teal-100 text-teal-800 text-xs rounded-full">Available</span>
            </div>
          </div>
