...
const OrganizationCard = ({ org, onAction }: { org: Organization; onAction: (action: string, orgId: string) => void }) => {
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="text-center bg-green-50 rounded-lg p-3">
            <div className="text-lg font-bold text-green-600">{org.contractValue}</div>
            <div className="text-xs text-green-700">Contract Value</div>
          </div>
          <div className="text-center bg-yellow-50 rounded-lg p-3">
            <div className={`text-lg font-bold ${getRatingColor(org.rating)} flex items-center justify-center`}>
        ...
        <div className="bg-blue-50 rounded-lg p-3">
          <div className="text-sm font-medium text-blue-800 mb-2">Primary Contact</div>
          <div className="space-y-1">
            <div className="text-sm font-medium">{org.primaryContact.name}</div>
            <div className="text-xs text-muted-foreground">{org.primaryContact.title}</div>
...
export default function DirectoryPage() {
  ...
  const clientOrganizations = organizationDirectory.filter(o => o.type === 'client').length;
  const partnerOrganizations = organizationDirectory.filter(o => o.type === 'partner').length;
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Complete directory of all clients, partners, and internal organizations
          </p>
        </div>
      </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600">{clientOrganizations}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">{partnerOrganizations}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-emerald-600">${totalContractValue.toLocaleString()}</p>
              </div>
