...
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs-fixed"; // Using fixed UI component without cn
      ...
      <div className="p-6">
        ...
        {isLoading ? (
          ...
          <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 rounded text-center">
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2">No Users Found</h3>
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            {selectedUserId ? (
              ...
              <UsersTable 
                ...
                onDeleteUser={checkPermission('delete:users') ? handleDeleteUser : undefined}
              />
            )}
          </div>
        )}
