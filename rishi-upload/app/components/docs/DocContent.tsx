...
import { createBreadcrumbsFromPath, formatDisplayDate } from '../../lib/client-utils';
...
export function DocContent({ content, metadata, currentPath }: DocContentProps) {
      ...
      <footer className="mt-16 pt-8 border-t border-[rgb(var(--border))] text-sm text-[rgb(var(--muted-foreground))]">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div className="flex items-center">
            ...
            <p>Last updated: <span className="font-medium text-[rgb(var(--foreground))]">{metadata.lastUpdated ? formatDisplayDate(metadata.lastUpdated) : 'Unknown'}</span></p>
          </div>
