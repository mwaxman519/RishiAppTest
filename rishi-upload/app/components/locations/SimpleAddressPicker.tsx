  ...
  useEffect(() => {
    ...
    function initializeGoogleComponents() {
      ...
      try {
        ...
        console.log('🔍 PlaceAutocompleteElement created successfully:', element);
        ...
        console.log('🔍 PlaceAutocompleteElement appended to DOM:', autocompleteContainerRef.current);
        ...
        setTimeout(() => {
          const inputElements = autocompleteContainerRef.current.querySelectorAll('input');
          console.log('🔍 Input elements found in container:', inputElements.length);
        ...
        console.log('🔍 Element prototype:', Object.getOwnPropertyNames(Object.getPrototypeOf(element)));
        ...
        element.addEventListener('gmp-placeselect', (event: any) => {
          ...
          try {
            ...
            // Check other possible locations
              ...
              console.error('🎯 Event:', JSON.stringify(event, (k, v) => typeof v === 'function' ? '[Function]' : v));
        ...
        console.log('🔍 PlaceAutocompleteElement initialized and attached to DOM');
          ...
          (result: any, status: any) => {
            ...
            if (status === window.google.maps.places.PlacesServiceStatus.OK && result) {
              ...
              if (result.geometry && result.geometry.location) {
                ...
                console.error('🔍 Place result missing geometry or location:', result);
                toast({
                  title: 'Error',
    ...
    if (window.google && window.google.maps && window.google.maps.places) {
      ...
      if (!existingScript) {
        ...
        script.onerror = () => {
          ...
          console.error('🔍 API Key used (first few chars):', apiKey ? apiKey.substring(0, 8) + '...' : 'none');
        ...
        console.log('🔍 Google Maps script already loading, waiting for callback');
      }
    }
