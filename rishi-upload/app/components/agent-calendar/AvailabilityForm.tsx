...
export default function AvailabilityForm({ userId, onSuccess, className = '' }: AvailabilityFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || 'Failed to create availability block');
      }
