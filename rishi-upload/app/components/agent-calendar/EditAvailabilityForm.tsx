...
export default function EditAvailabilityForm({ 
  ...
  const [formValues, setFormValues] = useState({
    ...
    dayOfWeek: availabilityBlock.dayOfWeek !== undefined 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updateData = {
        ...
        dayOfWeek: formValues.isRecurring ? parseInt(formValues.dayOfWeek.toString()) : undefined,
        day_of_week: formValues.isRecurring ? parseInt(formValues.dayOfWeek.toString()) : undefined,
        recurrencePattern: formValues.isRecurring ? formValues.recurrencePattern : undefined,
        recurrence_pattern: formValues.isRecurring ? formValues.recurrencePattern : undefined,
      };
      
      // Send update request
      const response = await fetch(`/api/availability/${availabilityBlock.id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || 'Failed to update availability block');
      }
