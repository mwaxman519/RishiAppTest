...
import { CheckCircle2, XCircle, Calendar, Clock, MapPin, Users, AlertTriangle, Loader2 } from 'lucide-react';
...
export default function BookingApproval({ booking, onApproved, onRejected }: BookingApprovalProps) {
  ...
  const handleApprove = async () => {
    try {
      ...
      toast({
        ...
        description: error.message || 'An error occurred while approving the booking.',
        variant: 'destructive'
      });
    } finally {
  ...
  const handleReject = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: error.message || 'An error occurred while rejecting the booking.',
        variant: 'destructive'
      });
    } finally {
      setIsSubmitting(false);
  ...
  return (
    <Card className="border-amber-200 bg-amber-50 dark:border-amber-800 dark:bg-amber-950/50">
      <CardHeader className="pb-2">
        ...
        <CardDescription>
          This booking is pending approval. Review the details and approve or reject the request.
        </CardDescription>
      </CardHeader>
        ...
        <Dialog open={isRejectDialogOpen} onOpenChange={setIsRejectDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Please provide a reason for rejecting this booking. This will be communicated to the client.
              </DialogDescription>
            </DialogHeader>
        ...
        <Dialog open={isApproveDialogOpen} onOpenChange={setIsApproveDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Are you sure you want to approve this booking? This will confirm the booking with the client.
              </DialogDescription>
            </DialogHeader>
            
            <div className="py-4">
              <div className="flex items-center justify-between space-x-2">
                <Label htmlFor="generate-events" className="flex flex-col space-y-1 cursor-pointer">
                  <span>Generate Event Instances</span>
                  <span className="font-normal text-xs text-muted-foreground">
                    Automatically create events for this booking based on its schedule
                  </span>
                </Label>
                <Switch
                  id="generate-events"
