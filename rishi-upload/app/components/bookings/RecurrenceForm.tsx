      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Is this a recurring event?</p>
          </div>
          <Switch
            checked={isRecurring}
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-md font-medium">Repeat</h3>
          <p className="text-sm text-muted-foreground">Configure recurring event pattern</p>
        </div>
        <Switch
          checked={isRecurring}
          onCheckedChange={onIsRecurringChange}
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <span>
                    {currentPattern.frequency === RecurrenceFrequency.DAILY && 'days'}
                    {currentPattern.frequency === RecurrenceFrequency.WEEKLY && 'weeks'}
                    {currentPattern.frequency === RecurrenceFrequency.MONTHLY && 'months'}
                    {currentPattern.frequency === RecurrenceFrequency.YEARLY && 'years'}
                  </span>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <Label>Ends</Label>
                <RadioGroup value={endType} onValueChange={handleEndTypeChange as any} className="space-y-3">
                  <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="on" className="font-normal">On date</Label>
                    <Popover>
                      <PopoverTrigger asChild>
                        <Button
                          ...
                          className={cn(
                            ...
                            endType !== 'on' && "opacity-50 pointer-events-none"
                          )}
                        >
