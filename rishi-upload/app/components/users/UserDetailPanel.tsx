      ...
      <div className="pt-14 px-6 pb-6">
        ...
        {showDeleteConfirm && (
          <div className="mb-4 p-4 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded">
            <h3 className="text-lg font-medium text-red-800 dark:text-red-300">Confirm Deletion</h3>
        ...
        <Tabs defaultValue="details" className="mt-6">
                  ...
                  >
                    {checkPermission('assign:any_role') && (
                      <>
                        ...
                        <option value={USER_ROLES.INTERNAL_ADMIN}>Internal Admin</option>
                      </>
                    )}
                    <option value={USER_ROLES.INTERNAL_FIELD_MANAGER}>Internal Field Manager</option>
                    <option value={USER_ROLES.FIELD_COORDINATOR}>Field Coordinator</option>
                    ...
                    <option value={USER_ROLES.CLIENT_MANAGER}>Client Manager</option>
          ...
          <TabsContent value="activity">
            <div className="bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-lg p-6 text-center">
              <h3 className="text-lg font-medium text-gray-700 dark:text-gray-300">Activity Tracking</h3>
          ...
          <TabsContent value="permissions">
            <div className="bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-medium text-gray-700 dark:text-gray-300">Role-Based Permissions</h3>
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-4">
                This user has the <span className="font-semibold">{formatRoleName(user.role)}</span> role, which includes a set of predefined permissions.
              </p>
              ...
              <div className="mt-4">
                ...
                <div className="bg-white dark:bg-gray-800 p-4 rounded border border-gray-200 dark:border-gray-700">
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    To view or modify specific permissions for this user, use the Manage Permissions button above.
                  </p>
                </div>
              </div>
            </div>
