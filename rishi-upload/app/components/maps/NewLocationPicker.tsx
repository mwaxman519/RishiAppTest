 ...
 */
export function NewLocationPicker({ onLocationSelect, className = '' }: LocationPickerProps) {
  ...
  const handleTestLocation = () => {
    const testLocation: LocationData = {
      ...
      addressComponents: [
        ...
        { longText: 'Financial District', shortText: 'Financial District', types: ['neighborhood'] },
        { longText: 'San Francisco', shortText: 'SF', types: ['locality'] },
        { longText: 'San Francisco County', shortText: 'San Francisco County', types: ['administrative_area_level_2'] },
  ...
  return (
    <div className={className}>
      ...
      <div className="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-md text-yellow-800 text-sm">
        <strong>Important Update:</strong> Our location search now uses Google's new Web Components (March 2025).
        {" "}We've implemented a simplified direct approach that properly displays dropdown suggestions.
      </div>
      ...
      {/* Map */}
      <div className="relative border border-input bg-muted/20 rounded-md overflow-hidden" style={{ height: '350px' }}>
        {isLoaded && (
          <GoogleMap
