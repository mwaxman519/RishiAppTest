        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between border-b pb-2">
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Slow query performance detected • 15 minutes ago</div>
                  </div>
                  <Link
                    href="/admin/alerts/1"
                ...
                <div className="flex justify-between">
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Rate limit threshold reached • 42 minutes ago</div>
                  </div>
                  <Link
                    href="/admin/alerts/2"
                    className="text-xs font-medium text-primary hover:underline self-center"
          ...
          <Card className="border-amber-200">
            <CardHeader className="pb-3">
              ...
              <CardDescription>Recent security activity on the platform</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                <div className="flex justify-between border-b pb-2">
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">5 attempts from IP 192.168.1.25 • 30 minutes ago</div>
                  </div>
                  <Link
                ...
                <div className="flex justify-between">
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">User role modified by super admin • 2 hours ago</div>
                  </div>
                  <Link
      ...
      <div>
        ...
        <Card>
          <CardHeader className="pb-3">
            ...
            <CardDescription>Recently created or updated organizations</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              <div className="flex justify-between items-center border-b pb-2">
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">Client (Tier 3) • 12 users • 5 active events</div>
                </div>
              ...
              <div className="flex justify-between items-center border-b pb-2">
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">Client (Tier 2) • 8 users • 3 active events</div>
                </div>
                <div className="flex space-x-2">
                  <Link
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">Client (Tier 1) • 4 users • 1 active event</div>
                </div>
                <div className="flex space-x-2">
                  <Link
