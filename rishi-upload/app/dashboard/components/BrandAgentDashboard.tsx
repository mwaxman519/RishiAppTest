          ...
          <div className="relative z-10">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-4 lg:space-y-0">
              <div>
                ...
                <p className="text-emerald-100 text-lg">Ready to make today's events exceptional</p>
              </div>
              ...
              <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <CardDescription>Your confirmed and pending assignments</CardDescription>
                  </div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-3 sm:space-y-0">
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div className="text-right">
                            <p className="text-lg font-bold text-green-600">{event.pay}</p>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">Great job on the Tech Hub event! Client was very impressed.</p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">Tomorrow's event location has been updated. Check details.</p>
