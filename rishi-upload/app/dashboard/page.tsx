...
import { BarChart3, Calendar, Clock, MapPin, Users, Database, Server, Globe, Shield, BadgeAlert } from "lucide-react";
  ...
  return (
    <AppLayout>
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Card className="bg-[rgb(var(--card))] border-[rgb(var(--border))]">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-[rgb(var(--card-foreground))]">Total Bookings</CardTitle>
              <Calendar className="h-4 w-4 text-[rgb(var(--muted-foreground))]" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-[rgb(var(--card-foreground))]">24</div>
          ...
          <Card className="bg-[rgb(var(--card))] border-[rgb(var(--border))]">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-[rgb(var(--card-foreground))]">Upcoming Events</CardTitle>
              <Clock className="h-4 w-4 text-[rgb(var(--muted-foreground))]" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-[rgb(var(--card-foreground))]">16</div>
              <p className="text-xs text-[rgb(var(--muted-foreground))]">
                3 events this week
              </p>
            </CardContent>
          ...
          <Card className="bg-[rgb(var(--card))] border-[rgb(var(--border))]">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-[rgb(var(--card-foreground))]">Active Locations</CardTitle>
              <MapPin className="h-4 w-4 text-[rgb(var(--muted-foreground))]" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-[rgb(var(--card-foreground))]">12</div>
              <p className="text-xs text-[rgb(var(--muted-foreground))]">
                Across 5 regions
              </p>
            </CardContent>
          ...
          <Card className="bg-[rgb(var(--card))] border-[rgb(var(--border))]">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-[rgb(var(--card-foreground))]">Staff Assigned</CardTitle>
              <Users className="h-4 w-4 text-[rgb(var(--muted-foreground))]" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-[rgb(var(--card-foreground))]">48</div>
              <p className="text-xs text-[rgb(var(--muted-foreground))]">
        ...
        <div>
          <h2 className="text-xl font-semibold mb-4 text-[rgb(var(--foreground))]">System Status</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <Card className="bg-[rgb(var(--card))] border-red-200 dark:border-red-800">
              <CardHeader className="pb-3">
                ...
                <CardDescription className="text-[rgb(var(--muted-foreground))]">Alerts requiring attention</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  <div className="flex justify-between border-b border-[rgb(var(--border))] pb-2">
                    <div>
                      <div className="font-medium text-[rgb(var(--card-foreground))]">Database Performance</div>
                      <div className="text-sm text-[rgb(var(--muted-foreground))]">Slow query performance detected • 15 minutes ago</div>
                    </div>
                    <Link
                      href="/admin/alerts/1"
                  ...
                  <div className="flex justify-between">
                    <div>
                      <div className="font-medium text-[rgb(var(--card-foreground))]">API Rate Limiting</div>
                      <div className="text-sm text-[rgb(var(--muted-foreground))]">Rate limit threshold reached • 42 minutes ago</div>
                    </div>
                    <Link
                      href="/admin/alerts/2"
                      className="text-xs font-medium text-[rgb(var(--primary))] hover:underline self-center"
            ...
            <Card className="bg-[rgb(var(--card))] border-amber-200 dark:border-amber-800">
              <CardHeader className="pb-3">
                ...
                <CardDescription className="text-[rgb(var(--muted-foreground))]">Recent security activity on the platform</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  <div className="flex justify-between border-b border-[rgb(var(--border))] pb-2">
                    <div>
                      <div className="font-medium text-[rgb(var(--card-foreground))]">Failed Login Attempts</div>
                      <div className="text-sm text-[rgb(var(--muted-foreground))]">5 attempts from IP 192.168.1.25 • 30 minutes ago</div>
                    </div>
                    <Link
                  ...
                  <div className="flex justify-between">
                    <div>
                      <div className="font-medium text-[rgb(var(--card-foreground))]">Permission Escalation</div>
                      <div className="text-sm text-[rgb(var(--muted-foreground))]">User role modified by super admin • 2 hours ago</div>
                    </div>
                    <Link
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <CardContent>
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-[rgb(var(--card-foreground))]">Query Performance</span>
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-[rgb(var(--card-foreground))]">Storage Usage</span>
            ...
            <Card className="bg-[rgb(var(--card))] border-[rgb(var(--border))]">
              ...
              <CardContent>
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-[rgb(var(--card-foreground))]">CPU Usage</span>
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-[rgb(var(--card-foreground))]">Memory Usage</span>
            ...
            <Card className="bg-[rgb(var(--card))] border-[rgb(var(--border))]">
              ...
              <CardContent>
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-[rgb(var(--card-foreground))]">Response Time</span>
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-[rgb(var(--card-foreground))]">Error Rate</span>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          <Card className="col-span-2 bg-[rgb(var(--card))] border-[rgb(var(--border))]">
            <CardHeader>
              <CardTitle className="text-[rgb(var(--card-foreground))]">Recent Bookings</CardTitle>
                  ...
                  <div key={i} className="flex items-center">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-[rgb(var(--muted-foreground))]">
                        {new Date(2024, 4, i + 10).toLocaleDateString()} • Corporate HQ
                      </p>
                    </div>
          ...
          <Card className="bg-[rgb(var(--card))] border-[rgb(var(--border))]">
            <CardHeader>
              <CardTitle className="text-[rgb(var(--card-foreground))]">Upcoming Deadlines</CardTitle>
              <CardDescription className="text-[rgb(var(--muted-foreground))]">
              ...
              <div className="space-y-8">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="flex items-center">
                    ...
                    <div className="space-y-1">
                      <p className="text-sm font-medium leading-none text-[rgb(var(--card-foreground))]">
                        {['Budget Approval', 'Staff Allocation', 'Kit Preparation'][i - 1]}
                      </p>
                      <p className="text-sm text-[rgb(var(--muted-foreground))]">
                        Due in {i * 3} days
                      </p>
