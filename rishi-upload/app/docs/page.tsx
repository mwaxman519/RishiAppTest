...
export default async function DocsPage() {
  try {
    ...
    console.log(`[DOCS PAGE] Successfully loaded documentation from: ${DOCS_DIRECTORY}`);
    console.log(`[DOCS PAGE] Found ${recentDocuments.length} documents and built tree with ${Object.keys(docTree).length} root items`);
