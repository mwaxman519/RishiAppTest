...
export type CreateCannabisBookingRequest = z.infer<typeof CreateCannabisBookingSchema>;
...
export interface BookingServiceInterface {
  ...
  createBooking(request: CreateCannabisBookingRequest): Promise<CannabisBooking>;
  getBookingById(id: string): Promise<CannabisBooking | null>;
  updateBookingStatus(id: string, status: BookingStatus, stage: BookingStage, userId: string): Promise<CannabisBooking>;
  cancelBooking(id: string, reason: string, userId: string): Promise<CannabisBooking>;
  
  // Cannabis-specific operations
  assignStaffToBooking(bookingId: string, staffIds: string[], assignedBy: string): Promise<void>;
  assignKitToBooking(bookingId: string, kitIds: string[], assignedBy: string): Promise<void>;
...
export interface BookingEventBus {
  publish(eventType: BookingEventType, data: any, metadata?: any): Promise<void>;
  subscribe(eventType: BookingEventType, handler: (event: BookingEvent) => Promise<void>): Promise<void>;
