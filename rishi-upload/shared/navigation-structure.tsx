...
import { 
  ...
  Home, User, Layers, GraduationCap, ClipboardList, BookOpenCheck, Receipt, DollarSign
} from 'lucide-react';
...
export function getPlatformAdminNav(): NavItem[] {
  return superAdminNavigation.filter(item => item.label === 'Platform Administration');
}
