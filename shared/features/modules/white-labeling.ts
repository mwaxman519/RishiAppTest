...
export const WhiteLabelingFeature: FeatureModule = {
  id: 'white-labeling',
  name: 'White Labeling',
  description: 'Customize the platform with your own branding, including logo, colors, and domain.',
  icon: 'layers',
  ...
  initializeForOrganization: async (organizationId: string) => {
    console.log(`Initializing white labeling feature for organization ${organizationId}`);
