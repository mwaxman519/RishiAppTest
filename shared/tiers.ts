...
export const TIER_DESCRIPTIONS = {
  [OrganizationTier.TIER1]: 'Lease Brand Agents for your events. You manage your events and bookings.',
  [OrganizationTier.TIER2]: 'Request full-service event staffing. We handle agent coordination.',
  [OrganizationTier.TIER3]: 'White-label solution with complete customization and your own staff.',
};
