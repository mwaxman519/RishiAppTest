...
export const ROLE_PERMISSIONS: Record<UserRole, string[]> = {
  ...
  internal_admin: [
    ...
    "!delete:system", "!edit:system_config" 
  ],
  
  internal_field_manager: [
    "view:*", "edit:staff", "edit:events", "edit:assignments",
    "create:staff", "create:events", "create:assignments",
    "delete:events", "delete:assignments"
  ],
  
  field_coordinator: [
    "view:staff", "view:events", "view:assignments", "view:clients",
    "edit:assignments", "create:assignments"
  ],
  
  brand_agent: [
    "view:assignments:own", "view:events:assigned", "view:profile:own",
    "edit:profile:own", "edit:availability:own", "view:schedule:own"
  ],
  
  client_manager: [
    "view:events", "view:assignments", "view:billing", "view:staff",
    "edit:events", "create:events", "edit:organization_settings",
    "edit:organization_users"
  ],
  
  client_user: [
    "view:events", "view:assignments", "view:staff",
    "create:events"
  ],
 ...
 */
export function permissionMatches(permission: string, permissionList: string[]): boolean {
...
export function getRolePermissions(role: UserRole): string[] {
  ...
  for (const inheritedRole of inheritedRoles) {
    inheritedPermissions = [...inheritedPermissions, ...ROLE_PERMISSIONS[inheritedRole as UserRole]];
  }
